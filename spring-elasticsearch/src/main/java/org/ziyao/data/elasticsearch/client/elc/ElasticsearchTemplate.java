...
import org.ziyao.data.elasticsearch.BulkFailureException;
import org.ziyao.data.elasticsearch.client.UnsupportedBackendOperation;
...
public class ElasticsearchTemplate extends AbstractElasticsearchTemplate {
    ...
    @Override
    public org.ziyao.data.elasticsearch.core.query.UpdateResponse update(UpdateQuery updateQuery, IndexCoordinates index) {
        ...
        return org.ziyao.data.elasticsearch.core.query.UpdateResponse.of(TypeUtils.result(response.result()));
    }
    ...
    @Override
    public org.ziyao.data.elasticsearch.core.reindex.ReindexResponse reindex(org.ziyao.data.elasticsearch.core.reindex.ReindexRequest reindexRequest) {

 ...
 */
package org.ziyao.data.elasticsearch.client;
...
class ClientConfigurationBuilder
        implements ClientConfiguration.ClientConfigurationBuilderWithRequiredEndpoint, ClientConfiguration.MaybeSecureClientConfigurationBuilder {
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.elasticsearch.client.ClientConfiguration.ClientConfigurationBuilderWithRequiredEndpoint#connectedTo(java.lang.String[])
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.elasticsearch.client.ClientConfiguration.ClientConfigurationBuilderWithRequiredEndpoint#connectedTo(java.net.InetSocketAddress[])
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.elasticsearch.client.ClientConfiguration.MaybeSecureClientConfigurationBuilder#usingSsl()
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.elasticsearch.client.ClientConfiguration.MaybeSecureClientConfigurationBuilder#usingSsl(javax.net.ssl.SSLContext)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.elasticsearch.client.ClientConfiguration.MaybeSecureClientConfigurationBuilder#usingSsl(javax.net.ssl.SSLContext, javax.net.ssl.HostnameVerifier)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.elasticsearch.client.ClientConfiguration.TerminalClientConfigurationBuilder#withDefaultHeaders(org.springframework.http.HttpHeaders)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.elasticsearch.client.ClientConfiguration.TerminalClientConfigurationBuilder#withConnectTimeout(java.time.Duration)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.elasticsearch.client.ClientConfiguration.TerminalClientConfigurationBuilder#withTimeout(java.time.Duration)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.elasticsearch.client.ClientConfiguration.ClientConfigurationBuilderWithOptionalDefaultHeaders#build()
     */
    @Override

...
import org.ziyao.data.format.datetime.DateFormatterRegistrar;
...
import org.ziyao.data.elasticsearch.annotations.ScriptedField;
...
/**
 * Elasticsearch specific {@link EntityConverter} implementation based on domain type
...
public class MappingElasticsearchConverter
    ...
    private static class Reader extends Base {
        ...
        private class ConverterAwareSpELExpressionParameterValueProvider
            ...
            /*
             * (non-Javadoc)
             * @see org.ziyao.data.mapping.model.SpELExpressionParameterValueProvider#potentiallyConvertSpelValue(java.lang.Object, org.ziyao.data.mapping.PreferredConstructor.Parameter)
             */
            @Override
    ...
    private void updatePropertiesInCriteria(Criteria criteria, ElasticsearchPersistentEntity<?> persistentEntity) {
        ...
        for (int i = 0; i < fieldNames.length; i++) {
            ...
            if (persistentProperty != null) {
                ...
                org.ziyao.data.elasticsearch.annotations.Field fieldAnnotation = persistentProperty
                        .findAnnotation(org.ziyao.data.elasticsearch.annotations.Field.class);

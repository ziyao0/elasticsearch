 ...
 * dedicated logger: {@code org.ziyao.data.elasticsearch.client.WIRE} on trace level.
 *
 * @author Mark Paluch
...
public abstract class ClientLogger {
	...
	private static final Log WIRE_LOGGER = LogFactory.getLog("org.ziyao.data.elasticsearch.client.WIRE");

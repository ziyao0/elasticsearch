...
import com.ziyao.springframework.data.repository.config.RepositoryBeanDefinitionRegistrarSupport;
...
class ElasticsearchRepositoriesRegistrar extends RepositoryBeanDefinitionRegistrarSupport {
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.repository.config.RepositoryBeanDefinitionRegistrarSupport#getAnnotation()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.repository.config.RepositoryBeanDefinitionRegistrarSupport#getExtension()
	 */
	@Override

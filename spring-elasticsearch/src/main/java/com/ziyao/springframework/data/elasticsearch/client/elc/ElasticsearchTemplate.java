...
import com.ziyao.springframework.data.elasticsearch.BulkFailureException;
import com.ziyao.springframework.data.elasticsearch.client.UnsupportedBackendOperation;
import com.ziyao.springframework.data.elasticsearch.core.*;
import com.ziyao.springframework.data.elasticsearch.core.cluster.ClusterOperations;
...
import static com.ziyao.springframework.data.elasticsearch.client.elc.TypeUtils.result;

/**
 * Implementation of {@link ElasticsearchOperations} using the new
...
public class ElasticsearchTemplate extends AbstractElasticsearchTemplate {
    ...
    private final com.ziyao.springframework.data.elasticsearch.client.elc.ElasticsearchExceptionTranslator exceptionTranslator;
    ...
    @Override
    public com.ziyao.springframework.data.elasticsearch.core.query.UpdateResponse update(UpdateQuery updateQuery, IndexCoordinates index) {

        UpdateRequest<Document, ?> request = requestConverter.documentUpdateRequest(updateQuery, index, getRefreshPolicy(),
                routingResolver.getRouting());
        UpdateResponse<Document> response = execute(
                client -> client.update(request, Document.class));
        return com.ziyao.springframework.data.elasticsearch.core.query.UpdateResponse.of(result(response.result()));
    }
    ...
    @Override
    public com.ziyao.springframework.data.elasticsearch.core.reindex.ReindexResponse reindex(com.ziyao.springframework.data.elasticsearch.core.reindex.ReindexRequest reindexRequest) {
    ...
    @Override
    public String submitReindex(com.ziyao.springframework.data.elasticsearch.core.reindex.ReindexRequest reindexRequest) {

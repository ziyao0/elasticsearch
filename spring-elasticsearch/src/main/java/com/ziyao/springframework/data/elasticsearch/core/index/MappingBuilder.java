 ...
 */
package com.ziyao.springframework.data.elasticsearch.core.index;
...
import com.ziyao.springframework.data.annotation.Transient;
import com.ziyao.springframework.data.elasticsearch.annotations.*;
import com.ziyao.springframework.data.elasticsearch.core.ResourceUtil;
import com.ziyao.springframework.data.elasticsearch.core.convert.ElasticsearchConverter;
import com.ziyao.springframework.data.elasticsearch.core.convert.ElasticsearchTypeMapper;
...
import com.ziyao.springframework.data.mapping.PropertyHandler;
...
public class MappingBuilder {
    ...
    protected String buildPropertyMapping(ElasticsearchPersistentEntity<?> entity,
                                          @Nullable Document runtimeFields) {
    ...
    @Nullable
    private Document getRuntimeFields(
    ...
    private class InternalBuilder {
        ...
        private void writeTypeHintMapping(ObjectNode propertiesNode) throws IOException {
            ...
            if (writeTypeHints) {
                ...
                propertiesNode.set(typeHintProperty, objectMapper.createObjectNode() //
                        .put(MappingParameters.FIELD_PARAM_TYPE, TYPE_VALUE_KEYWORD) //
                        .put(MappingParameters.FIELD_PARAM_INDEX, false) //
                        .put(MappingParameters.FIELD_PARAM_DOC_VALUES, false));
            }
        }
        ...
        private void mapEntity(ObjectNode objectNode, @Nullable ElasticsearchPersistentEntity<?> entity,
            ...
            if (writeNestedProperties) {
                ...
                nestedObjectNode.put(MappingParameters.FIELD_PARAM_TYPE, type);
        ...
        private void applyGeoPointFieldMapping(ObjectNode propertiesNode, ElasticsearchPersistentProperty property)
            ...
            propertiesNode.set(property.getFieldName(),
                    objectMapper.createObjectNode().put(MappingParameters.FIELD_PARAM_TYPE, TYPE_VALUE_GEO_POINT));
        }
        ...
        private void applyCompletionFieldMapping(ObjectNode propertyNode, ElasticsearchPersistentProperty property,
            ...
            completionNode.put(MappingParameters.FIELD_PARAM_TYPE, TYPE_VALUE_COMPLETION);
            ...
            if (annotation != null) {
                ...
                if (StringUtils.hasLength(annotation.searchAnalyzer())) {
                    completionNode.put(MappingParameters.FIELD_PARAM_SEARCH_ANALYZER, annotation.searchAnalyzer());
                }

                if (StringUtils.hasLength(annotation.analyzer())) {
                    completionNode.put(MappingParameters.FIELD_PARAM_INDEX_ANALYZER, annotation.analyzer());
                }
        ...
        private void applyDisabledPropertyMapping(ObjectNode propertiesNode, ElasticsearchPersistentProperty property) {
            ...
            try {
                ...
                propertiesNode.set(property.getFieldName(), objectMapper.createObjectNode() //
                        .put(MappingParameters.FIELD_PARAM_TYPE, field.type().getMappedName()) //
        ...
        private void addJoinFieldMapping(ObjectNode propertiesNode, ElasticsearchPersistentProperty property)
            ...
            propertyNode.put(MappingParameters.FIELD_PARAM_TYPE, TYPE_VALUE_JOIN);
        ...
        private void addFieldMappingParameters(ObjectNode fieldNode, Annotation annotation, boolean nestedOrObjectField)
            ...
            if (!nestedOrObjectField && mappingParameters.isStore()) {
                fieldNode.put(MappingParameters.FIELD_PARAM_STORE, true);
            }

...
public interface ClientConfiguration {
    ...
    /**
     * Returns the {@link Duration connect timeout}.
     *
    ...
    /**
     * Returns the {@link Duration socket timeout} which is typically applied as SO-timeout/read timeout.
     *
    ...
    interface TerminalClientConfigurationBuilder {
        ...
        /**
         * Configure a {@link Duration} connect timeout.
         *
        ...
        /**
         * Configure a {@link Duration socket timeout} which is typically applied as SO-timeout/read timeout.
         *
         * @param timeout the timeout to use. Must not be {@literal null}.
         * @return the {@link TerminalClientConfigurationBuilder}
         * @see java.net.Socket#setSoTimeout(int)

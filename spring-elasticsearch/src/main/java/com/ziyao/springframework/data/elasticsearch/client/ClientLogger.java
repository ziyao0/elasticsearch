 ...
 * dedicated logger: {@code com.ziyao.springframework.data.elasticsearch.client.WIRE} on trace level.
 *
 * @author Mark Paluch
...
public abstract class ClientLogger {
	...
	private static final Log WIRE_LOGGER = LogFactory.getLog("com.ziyao.springframework.data.elasticsearch.client.WIRE");

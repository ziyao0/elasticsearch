...
import com.ziyao.springframework.data.repository.config.DefaultRepositoryBaseClass;
...
public @interface EnableElasticsearchRepositories {
	...
	/**
	 * Returns the key of the {@link com.ziyao.springframework.data.repository.query.QueryLookupStrategy} to be used for lookup
	 * queries for query methods. Defaults to
	 * {@link com.ziyao.springframework.data.repository.query.QueryLookupStrategy.Key#CREATE_IF_NOT_FOUND}.
	 *
	 * @return
	 */
	...
	/**
	 * Configures the name of the {@link ElasticsearchOperations} bean

...
import com.ziyao.springframework.data.elasticsearch.core.join.JoinField;
...
import com.ziyao.springframework.data.elasticsearch.core.query.SeqNoPrimaryTerm;
import com.ziyao.springframework.data.elasticsearch.core.routing.RoutingResolver;
import com.ziyao.springframework.data.mapping.IdentifierAccessor;
...
import com.ziyao.springframework.data.mapping.model.ConvertingPropertyAccessor;
...
public class EntityOperations {
	...
	private static class MapBackedEntity<T extends Map<String, Object>> implements AdaptableEntity<T> {
		...
		/*
		 * (non-Javadoc)
		 * @see com.ziyao.springframework.data.elasticsearch.core.EntityOperations.Entity#getId()
		 */
		@Override
		public Object getId() {
		...
		/*
		 * (non-Javadoc)
		 * @see com.ziyao.springframework.data.elasticsearch.core.EntityOperations.AdaptableEntity#populateIdIfNecessary(java.lang.Object)
		 */
		@Nullable
		@Override
		...
		/*
		 * (non-Javadoc)
		 * @see com.ziyao.springframework.data.elasticsearch.core.EntityOperations.AdaptableEntity#initializeVersionProperty()
		 */
		@Override
		...
		/*
		 * (non-Javadoc)
		 * @see com.ziyao.springframework.data.elasticsearch.core.EntityOperations.AdaptableEntity#getVersion()
		 */
		@Override
		@Nullable
		...
		/*
		 * (non-Javadoc)
		 * @see com.ziyao.springframework.data.elasticsearch.core.EntityOperations.AdaptableEntity#incrementVersion()
		 */
		@Override
		...
		/*
		 * (non-Javadoc)
		 * @see com.ziyao.springframework.data.elasticsearch.core.EntityOperations.Entity#getBean()
		 */
		@Override
		public T getBean() {
			return map;
		...
		/*
		 * (non-Javadoc)
		 * @see com.ziyao.springframework.data.elasticsearch.core.EntityOperations.Entity#isNew()
		 */
		@Override
		...
		/*
		 * (non-Javadoc)
		 * @see com.ziyao.springframework.data.elasticsearch.core.EntityOperations.Entity#getPersistentEntity()
		 */
		@Override
	...
	private static class SimpleMappedEntity<T extends Map<String, Object>> extends MapBackedEntity<T> {
		...
		/*
		 * (non-Javadoc)
		 * @see com.ziyao.springframework.data.elasticsearch.core.EntityOperations.UnmappedEntity#getId()
		 */
		@Override
		public Object getId() {

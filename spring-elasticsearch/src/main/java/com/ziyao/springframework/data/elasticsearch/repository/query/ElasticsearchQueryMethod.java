 ...
 */
package com.ziyao.springframework.data.elasticsearch.repository.query;

import com.ziyao.springframework.data.elasticsearch.annotations.CountQuery;
import com.ziyao.springframework.data.elasticsearch.annotations.Highlight;
import com.ziyao.springframework.data.elasticsearch.annotations.Query;
import com.ziyao.springframework.data.elasticsearch.core.SearchHit;
import com.ziyao.springframework.data.elasticsearch.core.SearchHits;
import com.ziyao.springframework.data.elasticsearch.core.mapping.ElasticsearchPersistentProperty;
import com.ziyao.springframework.data.elasticsearch.core.query.HighlightQuery;
import org.springframework.core.annotation.AnnotatedElementUtils;
import org.springframework.dao.InvalidDataAccessApiUsageException;
import com.ziyao.springframework.data.elasticsearch.core.SearchPage;
...
public class ElasticsearchQueryMethod extends QueryMethod {
	...
	private HighlightQuery createAnnotatedHighlightQuery() {
		return new HighlightQuery(
				com.ziyao.springframework.data.elasticsearch.core.query.highlight.Highlight.of(highlightAnnotation),
				getDomainClass());
	}

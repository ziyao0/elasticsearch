...
import com.ziyao.springframework.data.elasticsearch.core.query.Field;
    ...
    private static Query.Builder queryFor(Criteria.CriteriaEntry entry, Field field, @Nullable Float boost) {
        ...
        switch (key) {
            ...
            case NOT_EMPTY:
                ...
                break;
            case EQUALS:
                queryBuilder.queryString(QueryBuilders.queryStringQuery(fieldName, searchText, Operator.And, boost));
                break;
            case CONTAINS:
                queryBuilder.queryString(QueryBuilders.queryStringQuery(fieldName, '*' + searchText + '*', true, boost));
                break;
            case STARTS_WITH:
                queryBuilder.queryString(QueryBuilders.queryStringQuery(fieldName, searchText + '*', true, boost));
                break;
            case ENDS_WITH:
                ...
                break;
            case EXPRESSION:
                queryBuilder.queryString(QueryBuilders.queryStringQuery(fieldName, value.toString(), boost));
                break;
            case LESS:
                queryBuilder //
                        .range(rb -> rb //
            ...
            case FUZZY:
                ...
                break;
            case MATCHES:
                queryBuilder.match(QueryBuilders.matchQuery(fieldName, value.toString(), Operator.Or, boost));
                break;
            case MATCHES_ALL:
                queryBuilder.match(QueryBuilders.matchQuery(fieldName, value.toString(), Operator.And, boost));

...
import com.ziyao.springframework.data.elasticsearch.core.document.SearchDocument;
...
import com.ziyao.springframework.data.convert.CustomConversions;
import com.ziyao.springframework.data.elasticsearch.annotations.ScriptedField;
import com.ziyao.springframework.data.elasticsearch.core.mapping.PropertyValueConverter;
import com.ziyao.springframework.data.elasticsearch.core.query.*;
...
/**
 * Elasticsearch specific {@link com.ziyao.springframework.data.convert.EntityConverter} implementation based on domain type
...
public class MappingElasticsearchConverter
	...
	private static class Reader extends Base {
		...
		private class ConverterAwareSpELExpressionParameterValueProvider
			...
			/*
			 * (non-Javadoc)
			 * @see com.ziyao.springframework.data.mapping.model.SpELExpressionParameterValueProvider#potentiallyConvertSpelValue(java.lang.Object, com.ziyao.springframework.data.mapping.PreferredConstructor.Parameter)
			 */
			@Override
	...
	private void updatePropertiesInCriteria(Criteria criteria, ElasticsearchPersistentEntity<?> persistentEntity) {
		...
		for (int i = 0; i < fieldNames.length; i++) {
			...
			if (persistentProperty != null) {
				...
				com.ziyao.springframework.data.elasticsearch.annotations.Field fieldAnnotation = persistentProperty
						.findAnnotation(com.ziyao.springframework.data.elasticsearch.annotations.Field.class);

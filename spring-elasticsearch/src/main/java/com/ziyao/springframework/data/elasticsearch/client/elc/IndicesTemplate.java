...
import com.ziyao.springframework.data.elasticsearch.UncategorizedElasticsearchException;
import com.ziyao.springframework.data.elasticsearch.annotations.Mapping;
import com.ziyao.springframework.data.elasticsearch.core.IndexInformation;
import com.ziyao.springframework.data.elasticsearch.core.IndexOperations;
...
import com.ziyao.springframework.data.elasticsearch.core.index.*;
...
public class IndicesTemplate extends ChildTemplate<ElasticsearchIndicesClient> implements IndexOperations {
    ...
    @Override
    public boolean putTemplate(com.ziyao.springframework.data.elasticsearch.core.index.PutTemplateRequest putTemplateRequest) {
    ...
    @Override
    public TemplateData getTemplate(com.ziyao.springframework.data.elasticsearch.core.index.GetTemplateRequest getTemplateRequest) {
    ...
    @Override
    public boolean existsTemplate(com.ziyao.springframework.data.elasticsearch.core.index.ExistsTemplateRequest existsTemplateRequest) {
    ...
    @Override
    public boolean deleteTemplate(com.ziyao.springframework.data.elasticsearch.core.index.DeleteTemplateRequest deleteTemplateRequest) {

 ...
 */
package com.ziyao.springframework.data.elasticsearch.core.query.highlight;
...
public class Highlight {
	 ...
	 */
	public static Highlight of(com.ziyao.springframework.data.elasticsearch.annotations.Highlight highlight) {

		Assert.notNull(highlight, "highlight must not be null");

		com.ziyao.springframework.data.elasticsearch.annotations.HighlightParameters parameters = highlight.parameters();

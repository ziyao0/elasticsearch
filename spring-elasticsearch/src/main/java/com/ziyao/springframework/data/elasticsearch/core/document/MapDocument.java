 ...
 */
package com.ziyao.springframework.data.elasticsearch.core.document;

import com.fasterxml.jackson.core.JsonProcessingException;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.ziyao.springframework.data.elasticsearch.support.DefaultStringObjectMap;
import com.ziyao.springframework.data.mapping.MappingException;
...
class MapDocument implements Document {
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.elasticsearch.core.document.Document#hasId()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.elasticsearch.core.document.Document#getId()
	 */
	@Override
	public String getId() {
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.elasticsearch.core.document.Document#setId(java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.elasticsearch.core.document.Document#hasVersion()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.elasticsearch.core.document.Document#getVersion()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.elasticsearch.core.document.Document#setVersion(long)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.elasticsearch.core.document.Document#hasSeqNo()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.elasticsearch.core.document.Document#getSeqNo()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.elasticsearch.core.document.Document#setSeqNo()
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.elasticsearch.core.document.Document#hasPrimaryTerm()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.elasticsearch.core.document.Document#getPrimaryTerm()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.elasticsearch.core.document.Document#setPrimaryTerm()
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.elasticsearch.core.document.Document#toJson()
	 */
	@Override

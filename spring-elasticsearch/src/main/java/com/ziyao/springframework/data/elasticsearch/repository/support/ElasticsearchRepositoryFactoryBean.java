...
import com.ziyao.springframework.data.repository.core.support.RepositoryFactoryBeanSupport;
...
public class ElasticsearchRepositoryFactoryBean<T extends Repository<S, ID>, S, ID extends Serializable>
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.repository.core.support.RepositoryFactoryBeanSupport#afterPropertiesSet()
	 */
	@Override

 ...
 */
package com.ziyao.springframework.data.elasticsearch.repository.cdi;

import com.ziyao.springframework.data.elasticsearch.repository.ElasticsearchRepository;
import com.ziyao.springframework.data.elasticsearch.repository.support.ElasticsearchRepositoryFactory;
import com.ziyao.springframework.data.elasticsearch.core.ElasticsearchOperations;
import com.ziyao.springframework.data.repository.cdi.CdiRepositoryBean;
 ...
 * {@link ElasticsearchRepository} instances.
 *
...
public class ElasticsearchRepositoryBean<T> extends CdiRepositoryBean<T> {
	 ...
	 * @param detector detector for the custom {@link com.ziyao.springframework.data.repository.Repository} implementations
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.repository.cdi.CdiRepositoryBean#create(javax.enterprise.context.spi.CreationalContext, java.lang.Class)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.repository.cdi.CdiRepositoryBean#getScope()
	 */
	@Override

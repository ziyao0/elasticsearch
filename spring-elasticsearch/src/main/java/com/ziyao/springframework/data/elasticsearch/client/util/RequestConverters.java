 ...
 */
package com.ziyao.springframework.data.elasticsearch.client.util;
...
public class RequestConverters {
    ...
    public static Request getTemplates(GetIndexTemplatesRequest getIndexTemplatesRequest) {
        final String endpoint = new EndpointBuilder().addPathPartAsIs("_template")
    ...
    public static Request deleteTemplate(DeleteIndexTemplateRequest deleteIndexTemplateRequest) {
        ...
        String endpoint = new EndpointBuilder().addPathPartAsIs("_template").addPathPart(name).build();

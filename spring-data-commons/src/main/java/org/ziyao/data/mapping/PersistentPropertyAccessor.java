...
public interface PersistentPropertyAccessor<T> {
     ...
     * {@link org.ziyao.data.convert.ConversionService} is configured.
     *
     ...
     * {@link PersistentPropertyPathAccessor#getProperty(PersistentPropertyPath, AccessOptions.GetOptions)}
     * instead.
     */
    @Nullable
    @Deprecated

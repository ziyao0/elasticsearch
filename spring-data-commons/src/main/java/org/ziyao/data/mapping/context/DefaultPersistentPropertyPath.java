...
class DefaultPersistentPropertyPath<P extends PersistentProperty<P>> implements PersistentPropertyPath<P> {
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.mapping.context.PersistentPropertyPath#toDotPath(org.ziyao.data.convert.converter.Converter)
     */
    @Nullable
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.mapping.context.PersistentPropertyPath#toPath(java.lang.String, org.ziyao.data.convert.converter.Converter)
     */
    @Nullable

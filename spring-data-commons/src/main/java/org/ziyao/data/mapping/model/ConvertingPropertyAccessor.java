...
public class ConvertingPropertyAccessor<T> extends SimplePersistentPropertyPathAccessor<T> {
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.mapping.model.SimplePersistentPropertyPathAccessor#getTypedProperty(org.springframework.data.mapping.PersistentProperty, java.lang.Class)
     */
    @Nullable
    @Override

...
import org.ziyao.data.mapping.model.EntityInstantiator;
...
public interface PersistentEntity<T, P extends PersistentProperty<P>> extends Iterable<P> {
     ...
     * {@link EntityInstantiator} or handled by custom conversion
     * mechanisms entirely.
     ...
     * customer {@link EntityInstantiator} or handled by custom conversion
     * mechanisms entirely.
     * @since 2.7
     */
    @Nullable

...
class PersistentPropertyPathFactory<E extends PersistentEntity<?, P>, P extends PersistentProperty<P>> {
    ...
    static class DefaultPersistentPropertyPaths<T, P extends PersistentProperty<P>>
        ...
        /*
         * (non-Javadoc)
         * @see org.ziyao.data.mapping.PersistentPropertyPaths#getFirst()
         */
        @Override
        ...
        /*
         * (non-Javadoc)
         * @see org.ziyao.data.mapping.PersistentPropertyPaths#contains(java.lang.String)
         */
        @Override
        ...
        /*
         * (non-Javadoc)
         * @see org.ziyao.data.mapping.PersistentPropertyPaths#contains(org.ziyao.data.mapping.PropertyPath)
         */
        @Override
        ...
        /*
         * (non-Javadoc)
         * @see org.ziyao.data.mapping.PersistentPropertyPaths#dropPathIfSegmentMatches(java.util.function.Predicate)
         */
        @Override

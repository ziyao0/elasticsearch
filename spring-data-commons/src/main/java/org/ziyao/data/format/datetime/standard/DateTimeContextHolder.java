...
import org.ziyao.data.format.datetime.standard.DateTimeContext;
import org.springframework.lang.Nullable;

/**
 * A holder for a thread-local user {@link org.ziyao.data.format.datetime.standard.DateTimeContext}.
 *
...
public final class DateTimeContextHolder {
	...
	private static final ThreadLocal<org.ziyao.data.format.datetime.standard.DateTimeContext> dateTimeContextHolder =
	 ...
	 */
	public static void setDateTimeContext(@Nullable org.ziyao.data.format.datetime.standard.DateTimeContext dateTimeContext) {
	 ...
	 */
	@Nullable
	public static org.ziyao.data.format.datetime.standard.DateTimeContext getDateTimeContext() {

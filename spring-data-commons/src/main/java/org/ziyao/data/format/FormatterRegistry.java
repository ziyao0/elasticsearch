...
public interface FormatterRegistry extends ConverterRegistry {
     ...
     * @see #addFormatter(org.ziyao.data.format.Formatter)
     * @since 5.2
     */
     ...
     * @see #addFormatterForFieldType(Class, org.ziyao.data.format.Formatter)
     * @since 3.1
     */
    void addFormatter(org.ziyao.data.format.Formatter<?> formatter);

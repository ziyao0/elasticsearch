...
import org.ziyao.data.format.datetime.standard.DateTimeFormatterRegistrar;
import org.ziyao.data.format.number.NumberFormatAnnotationFormatterFactory;

/**
 * A specialization of {@link org.ziyao.data.format.support.FormattingConversionService} configured by default with
...
//		}
        ...
        if (jodaTimePresent) {
            ...
            new org.ziyao.data.format.datetime.joda.JodaTimeFormatterRegistrar().registerFormatters(formatterRegistry);
        } else {

...
/**
 * Formats fields annotated with the {@link DateTimeFormat} annotation using a {@link org.ziyao.data.format.datetime.DateFormatter}.
 *
 * @author Phillip Webb
 * @author Sam Brannen
 * @since 3.2
 * @see org.ziyao.data.format.datetime.joda.JodaDateTimeFormatAnnotationFormatterFactory
 */
public class DateTimeFormatAnnotationFormatterFactory  extends EmbeddedValueResolutionSupport
	...
	protected Formatter<Date> getFormatter(DateTimeFormat annotation, Class<?> fieldType) {
		org.ziyao.data.format.datetime.DateFormatter formatter = new DateFormatter();

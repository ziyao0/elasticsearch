...
import org.ziyao.data.format.datetime.joda.*;
import org.ziyao.data.format.datetime.joda.DateTimeFormatterFactory;
import org.ziyao.data.format.datetime.joda.DateTimeParser;
import org.ziyao.data.format.datetime.joda.DurationFormatter;
import org.ziyao.data.format.datetime.joda.JodaTimeConverters;
import org.ziyao.data.format.datetime.joda.LocalDateParser;
import org.ziyao.data.format.datetime.joda.LocalDateTimeParser;
import org.ziyao.data.format.datetime.joda.LocalTimeParser;
import org.ziyao.data.format.datetime.joda.MonthDayFormatter;
import org.ziyao.data.format.datetime.joda.PeriodFormatter;
import org.ziyao.data.format.datetime.joda.ReadableInstantPrinter;
import org.ziyao.data.format.datetime.joda.ReadablePartialPrinter;
import org.ziyao.data.format.datetime.joda.YearMonthFormatter;
...
public class JodaTimeFormatterRegistrar implements FormatterRegistrar {
	 ...
	 */
	private final Map<Type, org.ziyao.data.format.datetime.joda.DateTimeFormatterFactory> factories;
	...
	public void registerFormatters(FormatterRegistry registry) {
		org.ziyao.data.format.datetime.joda.JodaTimeConverters.registerConverters(registry);
		...
		addFormatterForFields(registry,
				new org.ziyao.data.format.datetime.joda.ReadablePartialPrinter(dateFormatter),
				new LocalDateParser(dateFormatter),
				LocalDate.class);

		addFormatterForFields(registry,
				new org.ziyao.data.format.datetime.joda.ReadablePartialPrinter(timeFormatter),
		...
		addFormatterForFields(registry,
				new org.ziyao.data.format.datetime.joda.ReadableInstantPrinter(dateTimeFormatter),
				new org.ziyao.data.format.datetime.joda.DateTimeParser(dateTimeFormatter),
		...
		registry.addFormatterForFieldType(Period.class, new org.ziyao.data.format.datetime.joda.PeriodFormatter());
		registry.addFormatterForFieldType(Duration.class, new org.ziyao.data.format.datetime.joda.DurationFormatter());
		registry.addFormatterForFieldType(YearMonth.class, new org.ziyao.data.format.datetime.joda.YearMonthFormatter());
		registry.addFormatterForFieldType(MonthDay.class, new org.ziyao.data.format.datetime.joda.MonthDayFormatter());

...
package org.ziyao.data.format.support;
...
import org.ziyao.data.convert.support.ConversionServiceFactory;
import org.ziyao.data.format.*;
...
public class FormattingConversionServiceFactoryBean
        implements FactoryBean<org.ziyao.data.format.support.FormattingConversionService>, EmbeddedValueResolverAware, InitializingBean {
    ...
    @Nullable
    private org.ziyao.data.format.support.FormattingConversionService conversionService;
     ...
     *                   {@link org.ziyao.data.convert.converter.Converter},
     *                   {@link org.ziyao.data.convert.converter.ConverterFactory},
     *                   {@link org.ziyao.data.convert.converter.GenericConverter}
     */
    ...
    private void registerFormatters(org.ziyao.data.format.support.FormattingConversionService conversionService) {
    ...
    @Override
    @Nullable
    public org.ziyao.data.format.support.FormattingConversionService getObject() {
        return this.conversionService;
    }

    @Override
    public Class<? extends org.ziyao.data.format.support.FormattingConversionService> getObjectType() {

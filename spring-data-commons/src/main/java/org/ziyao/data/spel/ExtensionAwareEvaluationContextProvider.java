...
import org.ziyao.data.annotation.AnnotationAwareOrderComparator;
import org.ziyao.data.spel.EvaluationContextExtensionInformation.ExtensionTypeInformation;
import org.ziyao.data.spel.EvaluationContextExtensionInformation.RootObjectInformation;
import org.ziyao.data.spel.spi.EvaluationContextExtension;
import org.ziyao.data.spel.spi.ExtensionIdAware;
import org.ziyao.data.spel.spi.Function;
import org.ziyao.data.util.Lazy;
import org.ziyao.data.util.Optionals;
import org.ziyao.data.util.Predicates;
...
public class ExtensionAwareEvaluationContextProvider implements EvaluationContextProvider {
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.spel.EvaluationContextProvider#getEvaluationContext(Object)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.spel.EvaluationContextProvider#getEvaluationContext(Object, ExpressionDependencies)
     */
    @Override
    ...
    class ExtensionAwarePropertyAccessor implements PropertyAccessor, MethodResolver {
        ...
        /*
         * (non-Javadoc)
         * @see org.ziyao.data.repository.query.ExtensionAwareEvaluationContextProvider.ReadOnlyPropertyAccessor#canRead(org.springframework.expression.EvaluationContext, java.lang.Object, java.lang.String)
         */
        @Override

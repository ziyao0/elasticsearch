...
public class RepositoryComposition {
    ...
    public Object invoke(Method method, Object... args) throws Throwable {
        return invoke(RepositoryInvocationMulticaster.NoOpRepositoryInvocationMulticaster.INSTANCE, method, args);
    }
    ...
    Method getMethod(Method method) {
        ...
        return methodCache.computeIfAbsent(method,
                key -> RepositoryFragments.findMethod(MethodLookup.InvokedMethod.of(key), methodLookup, fragments::methods));
    }
    ...
    public static class RepositoryFragments implements Streamable<RepositoryFragment<?>> {
        ...
        public Object invoke(Method invokedMethod, Method methodToCall, Object[] args) throws Throwable {
            return invoke(null, RepositoryInvocationMulticaster.NoOpRepositoryInvocationMulticaster.INSTANCE, invokedMethod, methodToCall, args);
        }
        ...
        @Nullable
        private static Method findMethod(MethodLookup.InvokedMethod invokedMethod, MethodLookup lookup,

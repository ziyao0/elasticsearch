...
class PagingAndSortingRepositoryInvoker extends CrudRepositoryInvoker {
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.repository.support.CrudRepositoryInvoker#invokeSortedFindAll(java.util.Optional)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.repository.support.CrudRepositoryInvoker#invokePagedFindAll(java.util.Optional)
     */
    @Override

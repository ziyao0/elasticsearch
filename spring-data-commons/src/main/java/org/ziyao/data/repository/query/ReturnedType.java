...
import org.ziyao.data.projection.ProjectionInformation;
...
public abstract class ReturnedType {
    ...
    private static final class ReturnedInterface extends ReturnedType {
        ...
        /*
         * (non-Javadoc)
         * @see org.ziyao.data.repository.query.ReturnedType#getReturnedType()
         */
        @Override
        ...
        /*
         * (non-Javadoc)
         * @see org.ziyao.data.repository.query.ReturnedType#needsCustomConstruction()
         */
        ...
        /*
         * (non-Javadoc)
         * @see org.ziyao.data.repository.query.ReturnedType#isProjecting()
         */
        @Override
        ...
        /*
         * (non-Javadoc)
         * @see org.ziyao.data.repository.query.ReturnedType#getTypeToRead()
         */
        @Nullable
        @Override
        ...
        /*
         * (non-Javadoc)
         * @see org.ziyao.data.repository.query.ReturnedType#getInputProperties()
         */
        @Override
    ...
    private static final class ReturnedClass extends ReturnedType {
        ...
        /*
         * (non-Javadoc)
         * @see org.ziyao.data.repository.query.ResultFactory.ReturnedTypeInformation#getReturnedType()
         */
        @Override
        public Class<?> getReturnedType() {
            return type;
        ...
        /*
         * (non-Javadoc)
         * @see org.ziyao.data.repository.query.ResultFactory.ReturnedType#getTypeToRead()
         */
        @NonNull
        public Class<?> getTypeToRead() {
            return type;
        ...
        /*
         * (non-Javadoc)
         * @see org.ziyao.data.repository.query.ResultFactory.ReturnedType#isProjecting()
         */
        @Override
        public boolean isProjecting() {
            return isDto();
        ...
        /*
         * (non-Javadoc)
         * @see org.ziyao.data.repository.query.ResultFactory.ReturnedType#needsCustomConstruction()
         */
        public boolean needsCustomConstruction() {
        ...
        /*
         * (non-Javadoc)
         * @see org.ziyao.data.repository.query.ResultFactory.ReturnedTypeInformation#getInputProperties()
         */
        @Override
        public List<String> getInputProperties() {

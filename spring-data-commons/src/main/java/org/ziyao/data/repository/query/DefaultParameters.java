...
public final class DefaultParameters extends Parameters<DefaultParameters, Parameter> {
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.repository.query.Parameters#createParameter(org.springframework.core.MethodParameter)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.repository.query.Parameters#createFrom(java.util.List)
     */
    @Override

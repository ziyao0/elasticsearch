...
import org.ziyao.data.metrics.ApplicationStartup;
import org.ziyao.data.metrics.StartupStep;
import org.ziyao.data.projection.DefaultMethodInvokingMethodInterceptor;
...
public abstract class RepositoryFactorySupport implements BeanClassLoaderAware, BeanFactoryAware {
    ...
    static class ImplementationMethodExecutionInterceptor implements MethodInterceptor {
        ...
        public ImplementationMethodExecutionInterceptor(RepositoryInformation information,
            ...
            this.invocationMulticaster = methodInvocationListeners.isEmpty() ? RepositoryInvocationMulticaster.NoOpRepositoryInvocationMulticaster.INSTANCE
                    : new RepositoryInvocationMulticaster.DefaultRepositoryInvocationMulticaster(methodInvocationListeners);
        }
        ...
        public Object invoke(@SuppressWarnings("null") MethodInvocation invocation) throws Throwable {
            ...
            try {
                ...
                org.ziyao.data.repository.util.ClassUtils.unwrapReflectionException(e);
            }
    ...
    private static class QueryCollectingQueryCreationListener implements QueryCreationListener<RepositoryQuery> {
        ...
        /* (non-Javadoc)
         * @see org.ziyao.data.repository.core.support.QueryCreationListener#onCreation(org.ziyao.data.repository.query.RepositoryQuery)
         */
        @Override
    ...
    static class RepositoryValidator {
        ...
        static {
            ...
            org.ziyao.data.repository.util.ClassUtils.ifPresent(
                    "org.ziyao.data.querydsl.QuerydslPredicateExecutor", RepositoryValidator.class.getClassLoader(),
                    it -> {
                        WELL_KNOWN_EXECUTORS.put(it, "Querydsl");
                    });

            org.ziyao.data.repository.util.ClassUtils.ifPresent(
                    "org.ziyao.data.querydsl.ReactiveQuerydslPredicateExecutor",
                    RepositoryValidator.class.getClassLoader(), it -> {
                        WELL_KNOWN_EXECUTORS.put(it, "Reactive Querydsl");
                    });

            org.ziyao.data.repository.util.ClassUtils.ifPresent(
                    "org.ziyao.data.repository.query.QueryByExampleExecutor",
                    RepositoryValidator.class.getClassLoader(), it -> {
                        WELL_KNOWN_EXECUTORS.put(it, "Query by Example");
                    });

            org.ziyao.data.repository.util.ClassUtils.ifPresent(
                    "org.ziyao.data.repository.query.ReactiveQueryByExampleExecutor",
                    RepositoryValidator.class.getClassLoader(), it -> {

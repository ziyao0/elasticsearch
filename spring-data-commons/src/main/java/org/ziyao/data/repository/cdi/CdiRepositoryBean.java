 ...
 */
package org.ziyao.data.repository.cdi;
...
import org.ziyao.data.repository.config.RepositoryFragmentConfiguration;
import org.ziyao.data.repository.core.support.RepositoryComposition;
import org.ziyao.data.repository.core.support.RepositoryFactorySupport;
import org.ziyao.data.repository.core.support.RepositoryFragment;
...
public abstract class CdiRepositoryBean<T> implements Bean<T>, PassivationCapable {
    ...
    protected T create(Supplier<? extends RepositoryFactorySupport> factorySupplier, Class<T> repositoryType) {
        ...
        RepositoryComposition.RepositoryFragments repositoryFragments = getRepositoryFragments(repositoryType, configuration);
     ...
     *
     * @param repositoryType must not be {@literal null}.
     * @return the {@link RepositoryComposition.RepositoryFragments}.
     * @since 2.1
     */
    ...
    private RepositoryComposition.RepositoryFragments getRepositoryFragments(Class<T> repositoryType,
        ...
        return RepositoryComposition.RepositoryFragments.from(repositoryFragments) //
     ...
     * and call {@link #create(RepositoryFactorySupport, Class, RepositoryComposition.RepositoryFragments)}.
     */
    @Deprecated
    protected T create(CreationalContext<T> creationalContext, Class<T> repositoryType,
    ...
    /**
     * Try to lookup a custom implementation for a {@link Repository}. Can only be

...
import org.ziyao.data.repository.RepositoryDefinition;
...
public class AnnotationRepositoryMetadata extends AbstractRepositoryMetadata {
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.repository.core.RepositoryMetadata#getIdType()
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.repository.core.RepositoryMetadata#getDomainType()
     */
    @Override

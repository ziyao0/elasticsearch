...
public abstract class RepositoryConfigurationSourceSupport implements RepositoryConfigurationSource {
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.repository.config.RepositoryConfigurationSource#getCandidates(org.springframework.core.io.ResourceLoader)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.repository.config.RepositoryConfigurationSource#getBeanNameGenerator()
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.repository.config.RepositoryConfigurationSource#toImplementationDetectionConfiguration()
     */
    @Override
    ...
    private class SpringImplementationDetectionConfiguration implements ImplementationDetectionConfiguration {
        ...
        /*
         * (non-Javadoc)
         * @see org.ziyao.data.repository.config.CustomRepositoryImplementationDetector.ImplementationDetectionConfiguration#getImplementationPostfix()
         */
        @Override
        ...
        /*
         * (non-Javadoc)
         * @see org.ziyao.data.repository.config.CustomRepositoryImplementationDetector.ImplementationDetectionConfiguration#getBasePackages()
         */
        @Override
        ...
        /*
         * (non-Javadoc)
         * @see org.ziyao.data.repository.config.CustomRepositoryImplementationDetector.ImplementationDetectionConfiguration#getExcludeFilters()
         */
        @Override
        public Streamable<TypeFilter> getExcludeFilters() {
        ...
        /*
         * (non-Javadoc)
         * @see org.ziyao.data.repository.config.CustomRepositoryImplementationDetector.ImplementationDetectionConfiguration#generateBeanName(org.springframework.beans.factory.config.BeanDefinition)
         */
        @Override

...
import org.ziyao.data.annotation.QueryAnnotation;
...
import static org.ziyao.data.repository.util.ClassUtils.isGenericRepositoryInterface;
...
class DefaultRepositoryInformation implements RepositoryInformation {
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.repository.support.RepositoryMetadata#getDomainClass()
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.repository.support.RepositoryMetadata#getIdClass()
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.repository.support.RepositoryInformation#getRepositoryBaseClass()
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.repository.support.RepositoryInformation#getTargetClassMethod(java.lang.reflect.Method)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.repository.support.RepositoryInformation#getQueryMethods()
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.repository.support.RepositoryInformation#isCustomMethod(java.lang.reflect.Method)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.repository.core.RepositoryInformation#isQueryMethod(java.lang.reflect.Method)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.repository.core.RepositoryInformation#isBaseClassMethod(java.lang.reflect.Method)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.repository.support.RepositoryInformation#hasCustomMethod()
     */
    @Override

 ...
 */
package org.ziyao.data.repository.config;
...
import org.ziyao.data.config.ConfigurationUtils;
...
public class DefaultRepositoryConfiguration<T extends RepositoryConfigurationSource>
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.repository.config.RepositoryConfiguration#getBeanId()
     */
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.repository.config.RepositoryConfiguration#getQueryLookupStrategyKey()
     */
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.repository.config.RepositoryConfiguration#getBasePackages()
     */
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.repository.config.RepositoryConfiguration#getImplementationBasePackages()
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.repository.config.RepositoryConfiguration#getRepositoryInterface()
     */
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.repository.config.RepositoryConfiguration#getConfigSource()
     */
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.repository.config.RepositoryConfiguration#getNamedQueryLocation()
     */
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.repository.config.RepositoryConfiguration#getImplementationClassName()
     */
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.repository.config.RepositoryConfiguration#getImplementationBeanName()
     */
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.repository.config.RepositoryConfiguration#getSource()
     */
    @Nullable
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.repository.config.RepositoryConfiguration#getConfigurationSource()
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.repository.config.RepositoryConfiguration#getRepositoryBaseClassName()
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.repository.config.RepositoryConfiguration#getRepositoryFactoryBeanClassName()
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.repository.config.RepositoryConfiguration#isLazyInit()
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.repository.config.RepositoryConfiguration#isPrimary()
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.repository.config.RepositoryConfiguration#getExcludeFilters()
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.repository.config.RepositoryConfiguration#toImplementationDetectionConfiguration(org.springframework.core.type.classreading.MetadataReaderFactory)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.repository.config.RepositoryConfiguration#toLookupConfiguration(org.springframework.core.type.classreading.MetadataReaderFactory)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.repository.config.RepositoryConfiguration#getResourceDescription()
     */
    @Override

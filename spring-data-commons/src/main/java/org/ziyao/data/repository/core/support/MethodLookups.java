...
interface MethodLookups {
    ...
    class RepositoryAwareMethodLookup implements MethodLookup {
        ...
        /*
         * (non-Javadoc)
         * @see org.ziyao.data.repository.core.support.MethodLookup#getLookups()
         */
        @Override
    ...
    class ReactiveTypeInteropMethodLookup extends RepositoryAwareMethodLookup {
        ...
        /*
         * (non-Javadoc)
         * @see org.ziyao.data.repository.core.support.MethodLookups.RepositoryAwareMethodLookup#getLookups()
         */
        @Override
        public List<MethodPredicate> getLookups() {

...
public class ParametersParameterAccessor implements ParameterAccessor {
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.repository.query.ParameterAccessor#getPageable()
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.repository.query.ParameterAccessor#getSort()
     */
    @Override
    public Sort getSort() {
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.repository.query.ParameterAccessor#getBindableValue(int)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.repository.query.ParameterAccessor#hasBindableNullValue()
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.repository.query.ParameterAccessor#iterator()
     */
    @Override

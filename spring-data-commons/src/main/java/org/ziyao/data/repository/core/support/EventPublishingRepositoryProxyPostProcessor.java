...
import org.ziyao.data.domain.AfterDomainEventPublication;
import org.ziyao.data.domain.DomainEvents;
...
public class EventPublishingRepositoryProxyPostProcessor implements RepositoryProxyPostProcessor {
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.repository.core.support.RepositoryProxyPostProcessor#postProcess(org.springframework.aop.framework.ProxyFactory, org.ziyao.data.repository.core.RepositoryInformation)
     */
    @Override

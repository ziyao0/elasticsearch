...
import org.ziyao.data.config.TypeFilterParser;
...
public class XmlRepositoryConfigurationSource extends RepositoryConfigurationSourceSupport {
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.repository.config.RepositoryConfigurationSource#getSource()
     */
    @Nullable
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.repository.config.RepositoryConfigurationSource#getBasePackages()
     */
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.repository.config.RepositoryConfigurationSource#getQueryLookupStrategyKey()
     */
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.repository.config.RepositoryConfigurationSource#getNamedQueryLocation()
     */
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.repository.config.RepositoryConfigurationSourceSupport#getExcludeFilters()
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.repository.config.RepositoryConfigurationSourceSupport#getIncludeFilters()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.ziyao.data.repository.config.RepositoryConfigurationSource#getRepositoryImplementationPostfix()
     */
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.repository.config.RepositoryConfigurationSource#getRepositoryFactoryBeanName()
     */
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.repository.config.RepositoryConfigurationSource#getRepositoryBaseClassName()
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.repository.config.RepositoryConfigurationSource#getRepositoryFactoryBeanClassName()
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.repository.config.RepositoryConfigurationSourceSupport#isConsideringNestedRepositoriesEnabled()
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.repository.config.RepositoryConfigurationSource#getAttribute(java.lang.String)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.repository.config.RepositoryConfigurationSource#getAttribute(java.lang.String, java.lang.Class)
     */
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.repository.config.RepositoryConfigurationSource#usesExplicitFilters()
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.repository.config.RepositoryConfigurationSource#getBootstrapMode()
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.repository.config.RepositoryConfigurationSource#getResourceDescription()
     */
    @Override
    @NonNull

 ...
 * @since 1.13
 * @deprecated since 2.4. Use {@link org.ziyao.data.support.PageableExecutionUtils} instead
 */
@Deprecated
public abstract class PageableExecutionUtils {
    ...
    public static <T> Page<T> getPage(List<T> content, Pageable pageable, LongSupplier totalSupplier) {
        return org.ziyao.data.support.PageableExecutionUtils.getPage(content, pageable, totalSupplier);
    }
}

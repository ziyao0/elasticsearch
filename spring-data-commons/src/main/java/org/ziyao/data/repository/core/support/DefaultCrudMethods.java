...
import static org.ziyao.data.util.Optionals.toStream;
...
public class DefaultCrudMethods implements CrudMethods {
    ...
    private static Optional<Method> selectMostSuitableDeleteMethod(RepositoryMetadata metadata) {
        ...
        return source//
                ...
                .flatMap(it -> Optionals.toStream(getMostSpecificMethod(it, repositoryInterface)))//
                .findFirst();
    }
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.repository.core.support.CrudMethods#getSaveMethod()
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.repository.core.support.CrudMethods#hasSaveMethod()
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.repository.core.support.CrudMethods#getFindAllMethod()
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.repository.core.support.CrudMethods#hasFindAllMethod()
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.repository.core.support.CrudMethods#getFindOneMethod()
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.repository.core.support.CrudMethods#hasFindOneMethod()
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.repository.core.support.CrudMethods#hasDelete()
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.repository.core.support.CrudMethods#getDeleteMethod()
     */
    @Override

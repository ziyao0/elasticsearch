...
import org.ziyao.data.util.MethodInvocationRecorder;
import org.ziyao.data.util.MethodInvocationRecorder.Recorded;
...
public class Sort implements Streamable<Sort.Order>, Serializable {
    ...
    public static class TypedSort<T> extends Sort {
        ...
        /*
         * (non-Javadoc)
         * @see org.ziyao.data.domain.Sort#iterator()
         */
        @Override
        public Iterator<Order> iterator() {
        ...
        /*
         * (non-Javadoc)
         * @see org.ziyao.data.domain.Sort#toString()
         */
        @Override
        public String toString() {

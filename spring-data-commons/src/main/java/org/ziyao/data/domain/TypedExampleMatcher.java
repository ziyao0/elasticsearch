...
class TypedExampleMatcher implements ExampleMatcher {
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.domain.ExampleMatcher#withIgnorePaths(java.lang.String...)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.domain.ExampleMatcher#withStringMatcher(java.lang.String)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.domain.ExampleMatcher#withIgnoreCase(boolean)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.domain.ExampleMatcher#withMatcher(java.lang.String, org.ziyao.data.domain.ExampleMatcher.MatcherConfigurer)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.domain.ExampleMatcher#withTransformer(java.lang.String, org.ziyao.data.domain.ExampleMatcher.PropertyValueTransformer)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.domain.ExampleMatcher#withIgnoreCase(java.lang.String...)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.domain.ExampleMatcher#withNullHandler(org.ziyao.data.domain.ExampleMatcher.NullHandler)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.domain.ExampleMatcher#getNullHandler()
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.domain.ExampleMatcher#getDefaultStringMatcher()
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.domain.ExampleMatcher#isIgnoreCaseEnabled()
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.domain.ExampleMatcher#getIgnoredPaths()
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.domain.ExampleMatcher#getPropertySpecifiers()
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.domain.ExampleMatcher#getMatchMode()
     */
    @Override

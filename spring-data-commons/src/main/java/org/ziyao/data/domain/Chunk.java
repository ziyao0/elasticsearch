...
abstract class Chunk<T> implements Slice<T>, Serializable {
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.domain.Slice#getNumber()
     */
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.domain.Slice#getSize()
     */
    public int getSize() {
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.domain.Slice#getNumberOfElements()
     */
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.domain.Slice#hasPrevious()
     */
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.domain.Slice#isFirst()
     */
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.domain.Slice#nextPageable()
     */
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.domain.Slice#previousPageable()
     */
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.domain.Slice#hasContent()
     */
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.domain.Slice#getContent()
     */
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.domain.Slice#getPageable()
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.domain.Slice#getSort()
     */
    @Override
    public Sort getSort() {

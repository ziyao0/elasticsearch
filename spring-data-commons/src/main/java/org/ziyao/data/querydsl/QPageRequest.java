...
import org.ziyao.data.domain.AbstractPageRequest;
...
public class QPageRequest extends AbstractPageRequest {
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.domain.AbstractPageRequest#next()
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.domain.AbstractPageRequest#previous()
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.domain.AbstractPageRequest#first()
     */
    @Override

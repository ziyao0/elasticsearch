...
class ParameterizedTypeInformation<T> extends ParentTypeAwareTypeInformation<T> {
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.util.TypeDiscoverer#doGetMapValueType()
     */
    @Override
    @Nullable
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.util.TypeDiscoverer#getTypeParameters()
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.util.TypeDiscoverer#isAssignableFrom(org.ziyao.data.util.TypeInformation)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.util.TypeDiscoverer#doGetComponentType()
     */
    @Override
    @Nullable
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.util.TypeDiscoverer#specialize(org.ziyao.data.util.ClassTypeInformation)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.util.ParentTypeAwareTypeInformation#hashCode()
     */
    @Override
    public int hashCode() {

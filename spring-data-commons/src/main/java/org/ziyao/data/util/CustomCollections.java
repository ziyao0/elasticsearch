...
public class CustomCollections {
    ...
    static class VavrCollections implements CustomCollectionRegistrar {
        ...
        /*
         * (non-Javadoc)
         * @see org.ziyao.data.util.CustomCollectionRegistrar#isAvailable()
         */
        @Override
        ...
        /*
         * (non-Javadoc)
         * @see org.ziyao.data.util.CustomCollectionRegistrar#getMapTypes()
         */
        @Override
        ...
        /*
         * (non-Javadoc)
         * @see org.ziyao.data.util.CustomCollectionRegistrar#getCollectionTypes()
         */
        @Override
        ...
        /*
         * (non-Javadoc)
         * @see org.ziyao.data.util.CustomCollectionRegistrar#getAllowedPaginationReturnTypes()
         */
        @Override
        ...
        /*
         * (non-Javadoc)
         * @see org.ziyao.data.util.CustomCollectionRegistrar#toJavaNativeCollection()
         */
        @Override

...
class TypeDiscoverer<S> implements TypeInformation<S> {
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.util.TypeInformation#getParameterTypes(java.lang.reflect.Constructor)
     */
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.util.TypeInformation#getProperty(java.lang.String)
     */
    @Nullable
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.util.TypeInformation#getRawTypeInformation()
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.util.TypeInformation#getActualType()
     */
    @Nullable
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.util.TypeInformation#isMap()
     */
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.util.TypeInformation#getMapValueType()
     */
    @Nullable
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.util.TypeInformation#isCollectionLike()
     */
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.util.TypeInformation#getComponentType()
     */
    @Nullable
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.util.TypeInformation#getReturnType(java.lang.reflect.Method)
     */
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.util.TypeInformation#getMethodParameterTypes(java.lang.reflect.Method)
     */
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.util.TypeInformation#getSuperTypeInformation(java.lang.Class)
     */
    @Nullable
    ...
    /* (non-Javadoc)
     * @see org.ziyao.data.util.TypeInformation#isAssignableFrom(org.ziyao.data.util.TypeInformation)
     */
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.util.TypeInformation#specialize(org.ziyao.data.util.ClassTypeInformation)
     */
    @Override
    ...
    private static class SyntheticParamterizedType implements ParameterizedType {
        ...
        /*
         * (non-Javadoc)
         * @see org.ziyao.data.util.ParentTypeAwareTypeInformation#equals(java.lang.Object)
         */
        @Override

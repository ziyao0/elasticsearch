...
import org.ziyao.data.annotation.CreatedDate;
import org.ziyao.data.annotation.LastModifiedBy;
import org.ziyao.data.annotation.LastModifiedDate;
...
public class MappingAuditableBeanWrapperFactory extends DefaultAuditableBeanWrapperFactory {
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.auditing.AuditableBeanWrapperFactory#getBeanWrapperFor(java.lang.Object)
     */
    @Override
    ...
    static class MappingMetadataAuditableBeanWrapper<T> extends DateConvertingAuditableBeanWrapper<T> {
        ...
        private static final AccessOptions.SetOptions OPTIONS = AccessOptions.defaultSetOptions() //
                .skipNulls() // ;
        ...
        /*
         * (non-Javadoc)
         * @see org.ziyao.data.auditing.AuditableBeanWrapper#setCreatedBy(java.lang.Object)
         */
        @Override
        ...
        /*
         * (non-Javadoc)
         * @see org.ziyao.data.auditing.AuditableBeanWrapper#setCreatedDate(java.util.Optional)
         */
        @Override
        ...
        /*
         * (non-Javadoc)
         * @see org.ziyao.data.auditing.AuditableBeanWrapper#setLastModifiedBy(java.util.Optional)
         */
        @Override
        ...
        /*
         * (non-Javadoc)
         * @see org.ziyao.data.auditing.AuditableBeanWrapper#getLastModifiedDate()
         */
        @Override
        ...
        /*
         * (non-Javadoc)
         * @see org.ziyao.data.auditing.AuditableBeanWrapper#setLastModifiedDate(java.util.Optional)
         */
        @Override
        ...
        /*
         * (non-Javadoc)
         * @see org.ziyao.data.auditing.AuditableBeanWrapper#getBean()
         */
        @Override
        public T getBean() {

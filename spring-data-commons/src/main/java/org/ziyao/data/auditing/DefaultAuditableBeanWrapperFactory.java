...
import org.ziyao.data.convert.Jsr310Converters;
import org.ziyao.data.convert.ThreeTenBackPortConverters;
...
class DefaultAuditableBeanWrapperFactory implements AuditableBeanWrapperFactory {
    ...
    static class AuditableInterfaceBeanWrapper
        ...
        /*
         * (non-Javadoc)
         * @see org.ziyao.data.auditing.AuditableBeanWrapper#setCreatedBy(java.util.Optional)
         */
        @Override
        ...
        /*
         * (non-Javadoc)
         * @see org.ziyao.data.auditing.DefaultAuditableBeanWrapperFactory.AuditableInterfaceBeanWrapper#setLastModifiedBy(java.util.Optional)
         */
        @Override

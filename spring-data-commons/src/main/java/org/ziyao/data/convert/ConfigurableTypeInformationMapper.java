...
public class ConfigurableTypeInformationMapper implements TypeInformationMapper {
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.convert.TypeInformationMapper#createAliasFor(org.ziyao.data.util.TypeInformation)
     */
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.convert.TypeInformationMapper#resolveTypeFrom(org.ziyao.data.mapping.Alias)
     */
    @Nullable
    @Override

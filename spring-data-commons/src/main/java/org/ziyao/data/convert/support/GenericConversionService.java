...
import org.ziyao.data.convert.converter.*;
...
public class GenericConversionService implements ConfigurableConversionService {
     ...
     */
    private static final GenericConverter NO_OP_CONVERTER = new GenericConversionService.NoOpConverter("NO_OP");

    /**
     * Used as a cache entry when no converter is available.
     * This converter is never returned.
     */
    private static final GenericConverter NO_MATCH = new GenericConversionService.NoOpConverter("NO_MATCH");
    ...
    public void addConverter(Converter<?, ?> converter) {
        ...
        addConverter(new GenericConversionService.ConverterAdapter(converter, typeInfo[0], typeInfo[1]));
    }

    @Override
    public <S, T> void addConverter(Class<S> sourceType, Class<T> targetType, Converter<? super S, ? extends T> converter) {
        addConverter(new GenericConversionService.ConverterAdapter(
    ...
    public void addConverterFactory(ConverterFactory<?, ?> factory) {
        ...
        addConverter(new GenericConversionService.ConverterFactoryAdapter(factory,
     ...
     * @throws org.ziyao.data.convert.ConversionException if a conversion exception occurred
     * @throws IllegalArgumentException                             if targetType is {@code null}
     */
    @Nullable
     ...
     */
    private static final class ConverterCacheKey implements Comparable<GenericConversionService.ConverterCacheKey> {
        ...
        public boolean equals(@Nullable Object other) {
            ...
            if (!(other instanceof GenericConversionService.ConverterCacheKey)) {
                return false;
            }
            GenericConversionService.ConverterCacheKey otherKey = (GenericConversionService.ConverterCacheKey) other;
        ...
        @Override
        public int compareTo(GenericConversionService.ConverterCacheKey other) {

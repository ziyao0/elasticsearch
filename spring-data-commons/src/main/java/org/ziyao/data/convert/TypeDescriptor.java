...
//        this.annotatedElement = new TypeDescriptor.AnnotatedElementAdapter(methodParameter.getParameterIndex() == -1 ?
...
//        @Override
//        public boolean equals(Object other) {
//            return (this == other || (other instanceof TypeDescriptor.AnnotatedElementAdapter &&
//                    Arrays.equals(this.annotations, ((TypeDescriptor.AnnotatedElementAdapter) other).annotations)));
//        }
//
//        @Override
//        public int hashCode() {

...
/**
 * Provides {@code AnnotationTypeMapping} information for a single source
 ...
 * a root {@code Annotation}.
 *
 * <p>Supports convention based merging of meta-annotations as well as implicit
 * and explicit {@code AliasFor @AliasFor} aliases. Also provides information
...
final class AnnotationTypeMappings {
     ...
     * @return the {@code AnnotationTypeMapping}
    ...
    /**
     * Create {@code AnnotationTypeMappings} for the specified annotation type.
     *
    ...
    /**
     * Cache created per {@code AnnotationFilter}.
     */
    private static class Cache {
        ...
        /**
         * Get or create {@code AnnotationTypeMappings} for the specified annotation type.
         *
         * @param annotationType         the annotation type
         * @param visitedAnnotationTypes the set of annotations that we have already
         *                               visited; used to avoid infinite recursion for recursive annotations which
         *                               some JVM languages support (such as Kotlin)
         * @return a new or existing {@code AnnotationTypeMappings} instance
         */

...
/**
 * {@code MergedAnnotations} implementation that searches for and adapts
 * annotations and meta-annotations using {@code AnnotationTypeMappings}.
 *
 * @author Phillip Webb
 * @author Sam Brannen
 * @since 5.2
...
final class TypeMappedAnnotations implements MergedAnnotations {
    ...
    /**
     * {@code AnnotationsProcessor} used to detect if an annotation is directly
    ...
    /**
     * {@code AnnotationsProcessor} that finds a single {@code MergedAnnotation}.
     */
    ...
    /**
     * {@code AnnotationsProcessor} that collects {@code Aggregate} instances.
     */
    ...
    /**
     * {@code Spliterator} used to consume merged annotations from the

 ...
 */
package org.ziyao.data.history;

import org.springframework.util.Assert;
import org.springframework.util.ReflectionUtils;
import org.ziyao.data.util.AnnotationDetectionFieldCallback;
import org.ziyao.data.util.AnnotationDetectionMethodCallback;
...
public class AnnotationRevisionMetadata<N extends Number & Comparable<N>> implements RevisionMetadata<N> {
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.repository.history.RevisionMetadata#getRevisionNumber()
     */
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.history.RevisionMetadata#getRevisionDate()
     */
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.repository.history.RevisionMetadata#getDelegate()
     */

...
public class SpelAwareProxyProjectionFactory extends ProxyProjectionFactory implements BeanFactoryAware {
    ...
    /*
     * (non-Javadoc)
     * @see org.ziyao.data.projection.ProxyProjectionFactory#createProjectionInformation(java.lang.Class)
     */
    @Override
    ...
    protected static class SpelAwareProjectionInformation extends DefaultProjectionInformation {
        ...
        /*
         * (non-Javadoc)
         * @see org.ziyao.data.projection.DefaultProjectionInformation#isInputProperty(java.beans.PropertyDescriptor)
         */
        @Override

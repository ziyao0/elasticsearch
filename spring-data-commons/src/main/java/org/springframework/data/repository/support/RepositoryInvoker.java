...
public interface RepositoryInvoker extends RepositoryInvocationInformation {
	...
	/**
	 * Invokes the method equivalent to {@link CrudRepository#save(Object)} on the
	 * repository.
	 *
	 * @param object
	...
	/**
	 * Invokes the method equivalent to {@link CrudRepository#findById(Object)}.
	 *
	 ...
	 * {@link PagingAndSortingRepository#findAll(Pageable)}), using the method taking
	 * a {@link Sort} if available (i.e. the equivalent to
	 * {@link PagingAndSortingRepository#findAll(Sort)} by extracting the {@link Sort}
	 ...
	 * available (i.e. the equivalent to
	 * {@link PagingAndSortingRepository#findAll(Sort)}) or the plain equivalent to
	 * {@link CrudRepository#findAll()}.
	 *
	...
	/**
	 * Invokes the method equivalent to {@link CrudRepository#deleteById(Object)}. The

...
/**
 * {@code MergedAnnotationSelector} implementations that provide various options
 * for {@code MergedAnnotation} instances.
 *
 * @author Phillip Webb
...
public abstract class MergedAnnotationSelectors {
    ...
    /**
     * {@code MergedAnnotationSelector} to select the nearest annotation.
     */
    ...
    /**
     * {@code MergedAnnotationSelector} to select the first directly declared
     * annotation.
     */

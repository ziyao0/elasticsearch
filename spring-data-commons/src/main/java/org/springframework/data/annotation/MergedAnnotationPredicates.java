 ...
 * {@code MergedAnnotation MergedAnnotations}.
 *
 * @author Phillip Webb
 * @since 5.2
 */
public abstract class MergedAnnotationPredicates {
    ...
    /**
     * Create a new {@code Predicate} that evaluates to {@code true} if the name of the
     * {@codeplain MergedAnnotation#getType() merged annotation type} is contained in
     * the specified array.
     *
     * @param <A>       the annotation type
     * @param typeNames the names that should be matched
     * @return a {@code Predicate} to test the annotation type
     */
    ...
    /**
     * Create a new {@code Predicate} that evaluates to {@code true} if the
     * {@codeplain MergedAnnotation#getType() merged annotation type} is contained in
     * the specified array.
     *
     * @param <A>   the annotation type
    ...
    /**
     * Create a new stateful, single use {@code Predicate} that matches only
     ...
     * @return a {@code Predicate} that matches the first run of the extracted
     * values
     */
    ...
    /**
     * Create a new stateful, single use {@code Predicate} that matches
     ...
     *                     uniqueness
     * @return a {@code Predicate} that matches a unique annotation based on the
     * extracted key
     */
    ...
    /**
     * {@code Predicate} implementation used for
     * {@code MergedAnnotationPredicates#firstRunOf(Function)}.
     */
    ...
    /**
     * {@code Predicate} implementation used for
     * {@code MergedAnnotationPredicates#unique(Function)}.
     */

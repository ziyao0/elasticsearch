...
public abstract class ReflectionUtils {
    ...
    /**
     * Pre-built {@code MethodFilter} that matches all non-bridge non-synthetic methods
    ...
    /**
     * Cache for {@code Class#getDeclaredMethods()} plus equivalent default methods
     * from Java 8 based interfaces, allowing for fast iteration.
     */
    private static final Map<Class<?>, Method[]> declaredMethodsCache = new ConcurrentReferenceHashMap<>(256);

    /**
     * Cache for {@code Class#getDeclaredFields()}, allowing for fast iteration.
     */
    ...
    /**
     * Rethrow the given {@code Throwable exception}, which is presumably the
     * <em>target exception</em> of an {@code InvocationTargetException}.
     * Should only be called if no checked exception is expected to be thrown
     * by the target method.
     * <p>Rethrows the underlying exception cast to a {@code RuntimeException} or
     * {@code Error} if appropriate; otherwise, throws an
     ...
     * Should only be called if no checked exception is expected to be thrown
     * by the target method.
     * <p>Rethrows the underlying exception cast to an {@code Exception} or
     * {@code Error} if appropriate; otherwise, throws an
     * {@code UndeclaredThrowableException}.
     *
    ...
    /**
     * Attempt to find a {@code Method} on the supplied class with the supplied name
     * and no parameters. Searches all superclasses up to {@code Object}.
     * <p>Returns {@code null} if no {@code Method} can be found.
     *
    ...
    /**
     * Invoke the specified {@code Method} against the supplied target object with no arguments.
     * The target object can be {@code null} when invoking a static {@code Method}.
     * <p>Thrown exceptions are handled via a call to {@code #handleReflectionException}.
     *
    ...
    /**
     * Invoke the specified {@code Method} against the supplied target object with the
     ...
     * twice, unless excluded by a {@code MethodFilter}.
     *
     * @param clazz the class to introspect
     * @param mc    the callback to invoke for each method
     * @throws IllegalStateException if introspection fails
     ...
     * <p>The same named method occurring on subclass and superclass will appear
     * twice, unless excluded by the specified {@code MethodFilter}.
     *
     * @param clazz the class to introspect
     * @param mc    the callback to invoke for each method
    ...
    /**
     * Variant of {@code Class#getDeclaredMethods()} that uses a local cache in
    ...
    /**
     * Determine whether the given method is originally declared by {@code Object}.
     */
    ...
    /**
     * Attempt to find a {@code Field field} on the supplied {@code Class} with the
     * supplied {@code name}. Searches all superclasses up to {@code Object}.
     *
     * @param clazz the class to introspect
    ...
    /**
     * Attempt to find a {@code Field field} on the supplied {@code Class} with the
     * supplied {@code name} and/or {@code Class type}. Searches all superclasses
     * up to {@code Object}.
     *
     * @param clazz the class to introspect
    ...
    /**
     * Set the field represented by the supplied {@codeplain Field field object} on
     * the specified {@codeplain Object target object} to the specified {@code value}.
     * <p>In accordance with {@code Field#set(Object, Object)} semantics, the new value
     * is automatically unwrapped if the underlying field has a primitive type.
     * <p>This method does not support setting {@code static final} fields.
     * <p>Thrown exceptions are handled via a call to {@code #handleReflectionException(Exception)}.
     *
    ...
    /**
     * Get the field represented by the supplied {@code Field field object} on the
     * specified {@code Object target object}. In accordance with {@code Field#get(Object)}
    ...
    /**
     * This variant retrieves {@code Class#getDeclaredFields()} from a local cache

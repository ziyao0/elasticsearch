...
import org.springframework.data.annotation.AnnotationTypeMapping.MirrorSets.MirrorSet;
import org.springframework.data.annotation.MergedAnnotation.Adapt;
 ...
 * consider using {@code org.ziyao.data.annotation.AnnotatedElementUtils}'s more specific methods instead.
 *
 * <h3>Attribute Aliases</h3>
 * <p>All public methods in this class that return annotations, arrays of
 * annotations, or {@code org.ziyao.data.annotation.AnnotationAttributes} transparently support attribute
 * aliases configured via {@code org.ziyao.data.annotation.AliasFor @AliasFor}. Consult the various
...
public abstract class AnnotationUtils {
    ...
    public static <A extends Annotation> Set<A> getRepeatableAnnotations(AnnotatedElement annotatedElement,
        ...
        return MergedAnnotations.from(annotatedElement, MergedAnnotations.SearchStrategy.SUPERCLASS, repeatableContainers)
    ...
    public static <A extends Annotation> Set<A> getDeclaredRepeatableAnnotations(AnnotatedElement annotatedElement,
        ...
        return MergedAnnotations.from(annotatedElement, MergedAnnotations.SearchStrategy.DIRECT, repeatableContainers)
                .stream(annotationType)
                .map(MergedAnnotation::withNonMergedAttributes)
                .collect(MergedAnnotationCollectors.toAnnotationSet());
    }
    ...
    public static boolean isAnnotationInherited(Class<? extends Annotation> annotationType, Class<?> clazz) {
        return MergedAnnotations.from(clazz, MergedAnnotations.SearchStrategy.INHERITED_ANNOTATIONS)
                .stream(annotationType)
     ...
     * set to {@code false}.
     * <p>Note: This method actually returns an {@code org.ziyao.data.annotation.AnnotationAttributes} instance.
     ...
     *                            compatibility with {@code org.ziyao.data.type.AnnotationMetadata})
    ...
    /**
     * Retrieve the given annotation's attributes as an {@code org.ziyao.data.annotation.AnnotationAttributes} map.
     * <p>This method provides fully recursive annotation reading capabilities on par with
     * the reflection-based {@code org.ziyao.data.type.StandardAnnotationMetadata}.
     *
     * @param annotation             the annotation to retrieve the attributes for
     * @param classValuesAsString    whether to convert Class references into Strings (for
     *                               compatibility with {@code org.ziyao.data.type.AnnotationMetadata})
     ...
     *                               {@code org.ziyao.data.annotation.AnnotationAttributes} maps (for compatibility with
     *                               {@code org.ziyao.data.type.AnnotationMetadata}) or to preserve them as
    ...
    /**
     * Post-process the supplied {@code org.ziyao.data.annotation.AnnotationAttributes}, preserving nested
     * annotations as {@code Annotation} instances.
     * <p>Specifically, this method enforces <em>attribute alias</em> semantics
     * for annotation attributes that are annotated with {@code org.ziyao.data.annotation.AliasFor @AliasFor}
     ...
     * value cannot be retrieved due to an {@code org.ziyao.data.annotation.AnnotationConfigurationException},
    ...
    /**
     * If the supplied throwable is an {@code org.ziyao.data.annotation.AnnotationConfigurationException},
     ...
     * <p>If the supplied exception is an {@code org.ziyao.data.annotation.AnnotationConfigurationException},
     ...
     * annotated with {@code org.ziyao.data.annotation.AliasFor @AliasFor}.
     *

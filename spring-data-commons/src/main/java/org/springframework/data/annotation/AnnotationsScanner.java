...
abstract class AnnotationsScanner {
    ...
    private static <C, R> R process(C context, AnnotatedElement source,
                                    MergedAnnotations.SearchStrategy searchStrategy, Predicate<Class<?>> searchEnclosingClass,
    ...
    @Nullable
    private static <C, R> R processClass(C context, Class<?> source, MergedAnnotations.SearchStrategy searchStrategy,
                                         Predicate<Class<?>> searchEnclosingClass, AnnotationsProcessor<C, R> processor) {
        ...
        switch (searchStrategy) {
            ...
            case SUPERCLASS:
                return processClassHierarchy(context, source, processor, false, MergedAnnotations.Search.never);
            case TYPE_HIERARCHY:
    ...
    private static <C, R> R processClassInheritedAnnotations(C context, Class<?> source,
        ...
        try {
            if (isWithoutHierarchy(source, searchStrategy, MergedAnnotations.Search.never)) {
                return processElement(context, source, processor);
            }

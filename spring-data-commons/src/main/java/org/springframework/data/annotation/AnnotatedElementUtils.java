...
public abstract class AnnotatedElementUtils {
     ...
     * <p>{@code org.ziyao.data.annotation.AliasFor @AliasFor} semantics are fully supported, both
     ...
     * of the same name from higher levels, and {@code org.ziyao.data.annotation.AliasFor @AliasFor} semantics are
     ...
     * {@code annotationType}.
     * <p>{@code org.ziyao.data.annotation.AliasFor @AliasFor} semantics are fully supported, both within a
     ...
     * {@code org.ziyao.data.annotation.AliasFor @AliasFor} semantics are fully supported, both
     * within a single annotation and within the annotation hierarchy.

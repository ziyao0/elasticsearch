...
import com.ziyao.springframework.data.annotation.AnnotationTypeMapping.MirrorSets.MirrorSet;
import com.ziyao.springframework.data.annotation.MergedAnnotation.Adapt;
import com.ziyao.springframework.data.annotation.MergedAnnotations.SearchStrategy;
 ...
 * lookup methods on this class (e.g. {@code #findAnnotation(Method, Class)} or
 * {@code #getAnnotation(Method, Class)}) instead of the plain annotation lookup
 * methods in the JDK. You can still explicitly choose between a <em>get</em>
 * lookup on the given class level only ({@code #getAnnotation(Method, Class)})
 * and a <em>find</em> lookup in the entire inheritance hierarchy of the given
 * method ({@code #findAnnotation(Method, Class)}).
 *
 * <h3>Terminology</h3>
 ...
 * javadoc for {@code AnnotatedElement} (in Java 8).
 *
 ...
 * consider using {@code com.ziyao.springframework.data.annotation.AnnotatedElementUtils}'s more specific methods instead.
 *
 * <h3>Attribute Aliases</h3>
 * <p>All public methods in this class that return annotations, arrays of
 * annotations, or {@code com.ziyao.springframework.data.annotation.AnnotationAttributes} transparently support attribute
 * aliases configured via {@code com.ziyao.springframework.data.annotation.AliasFor @AliasFor}. Consult the various
 ...
 * @see com.ziyao.springframework.data.annotation.AliasFor
 * @see com.ziyao.springframework.data.annotation.AnnotationAttributes
 * @see com.ziyao.springframework.data.annotation.AnnotatedElementUtils
...
public abstract class AnnotationUtils {
    ...
    /**
     * Get a single {@code Annotation} of {@code annotationType} from the supplied
    ...
    /**
     * Get a single {@code Annotation} of {@code annotationType} from the supplied
     * {@code AnnotatedElement}, where the annotation is either <em>present</em> or
     * <em>meta-present</em> on the {@code AnnotatedElement}.
     * <p>Note that this method supports only a single level of meta-annotations.
     * For support for arbitrary levels of meta-annotations, use
     * {@code #findAnnotation(AnnotatedElement, Class)} instead.
     *
    ...
    /**
     * Get a single {@code Annotation} of {@code annotationType} from the
     * supplied {@code Method}, where the annotation is either <em>present</em>
     * or <em>meta-present</em> on the method.
     * <p>Correctly handles bridge {@code Method Methods} generated by the compiler.
     * <p>Note that this method supports only a single level of meta-annotations.
     * For support for arbitrary levels of meta-annotations, use
     * {@code #findAnnotation(Method, Class)} instead.
     *
    ...
    /**
     * Get all {@code Annotation Annotations} that are <em>present</em> on the
     ...
     * @see AnnotatedElement#getAnnotations()
     * @since 4.0.8
     * @deprecated as of 5.2 since it is superseded by the {@code MergedAnnotations} API
     */
    @Deprecated
    @Nullable
    ...
    /**
     * Get the <em>repeatable</em> {@codeplain Annotation annotations} of
     * {@code annotationType} from the supplied {@code AnnotatedElement}, where
     * such annotations are either <em>present</em>, <em>indirectly present</em>,
     * or <em>meta-present</em> on the element.
     * <p>This method mimics the functionality of Java 8's
     * {@code AnnotatedElement#getAnnotationsByType(Class)}
     * with support for automatic detection of a <em>container annotation</em>
     * declared via @{@code java.lang.annotation.Repeatable} (when running on
     * Java 8 or higher) and with additional support for meta-annotations.
     * <p>Handles both single annotations and annotations nested within a
     * <em>container annotation</em>.
     * <p>Correctly handles <em>bridge methods</em> generated by the
     * compiler if the supplied element is a {@code Method}.
     ...
     * @see com.ziyao.springframework.data.annotation.AnnotatedElementUtils#getMergedRepeatableAnnotations(AnnotatedElement, Class)
     ...
     *                                or if it should be looked up via @{@code java.lang.annotation.Repeatable}
     *                                when running on Java 8 or higher
     * @return the annotations found or an empty set (never {@code null})
     * @see #getRepeatableAnnotations(AnnotatedElement, Class)
     * @see #getDeclaredRepeatableAnnotations(AnnotatedElement, Class)
     * @see #getDeclaredRepeatableAnnotations(AnnotatedElement, Class, Class)
     * @see com.ziyao.springframework.data.annotation.AnnotatedElementUtils#getMergedRepeatableAnnotations(AnnotatedElement, Class, Class)
     * @see BridgeMethodResolver#findBridgedMethod
     * @see java.lang.annotation.Repeatable
     * @see AnnotatedElement#getAnnotationsByType
     * @since 4.2
    ...
    /**
     * Get the declared <em>repeatable</em> {@codeplain Annotation annotations}
     * of {@code annotationType} from the supplied {@code AnnotatedElement},
     * where such annotations are either <em>directly present</em>,
     * <em>indirectly present</em>, or <em>meta-present</em> on the element.
     * <p>This method mimics the functionality of Java 8's
     * {@code AnnotatedElement#getDeclaredAnnotationsByType(Class)}
     * with support for automatic detection of a <em>container annotation</em>
     * declared via @{@code java.lang.annotation.Repeatable} (when running on
     * Java 8 or higher) and with additional support for meta-annotations.
     * <p>Handles both single annotations and annotations nested within a
    ...
    /**
     * Find a single {@code Annotation} of {@code annotationType} on the
     * supplied {@code AnnotatedElement}.
     * <p>Meta-annotations will be searched if the annotation is not
     ...
     * the more specific semantics of {@code #findAnnotation(Class, Class)}
     * or {@code #findAnnotation(Method, Class)}, invoke one of those methods
     * instead.
     *
    ...
    /**
     * Find a single {@code Annotation} of {@code annotationType} on the supplied
     * {@code Method}, traversing its super methods (i.e. from superclasses and
    ...
    /**
     * Find a single {@code Annotation} of {@code annotationType} on the
     * supplied {@code Class}, traversing its interfaces, annotations, and
     * superclasses if the annotation is not <em>directly present</em> on
     * the given class itself.
     * <p>This method explicitly handles class-level annotations which are not
     * declared as {@code java.lang.annotation.Inherited inherited} <em>as well
    ...
    /**
     * Find the first {@code Class} in the inheritance hierarchy of the
     ...
     * not be traversed.
     * <p>Meta-annotations will <em>not</em> be searched.
     * <p>The standard {@code Class} API does not provide a mechanism for
     * determining which class in an inheritance hierarchy actually declares
     * an {@code Annotation}, so we need to handle this explicitly.
     *
     * @param annotationType the annotation type to look for
     * @param clazz          the class to check for the annotation on (may be {@code null})
     * @return the first {@code Class} in the inheritance hierarchy that
     ...
     * <p>The standard {@code Class} API does not provide a mechanism for
     * determining which class in an inheritance hierarchy actually declares
     * one of several candidate {@codeplain Annotation annotations}, so we
     ...
     * {@code clazz}.
     * <p>The supplied {@code Class} may represent any type.
     * <p>Meta-annotations will <em>not</em> be searched.
     * <p>Note: This method does <strong>not</strong> determine if the annotation
     * is {@codeplain java.lang.annotation.Inherited inherited}.
     *
     * @param annotationType the annotation type to look for
     ...
     * {@codeplain java.lang.annotation.Inherited inherited}
     * (i.e. not <em>directly present</em>).
     * <p>Meta-annotations will <em>not</em> be searched.
     * <p>If the supplied {@code clazz} is an interface, only the interface
     * itself will be checked. In accordance with standard meta-annotation
     * semantics in Java, the inheritance hierarchy for interfaces will not
     * be traversed. See the {@codeplain java.lang.annotation.Inherited javadoc}
    ...
    /**
     * Determine if the supplied {@code Annotation} is defined in the core JDK
    ...
    /**
     * Determine if the {@code Annotation} with the supplied name is defined
     ...
     * <p>This method not failing indicates that {@code #getAnnotationAttributes(Annotation)}
    ...
    /**
     * Retrieve the given annotation's attributes as a {@code Map}, preserving all
     * attribute types.
     * <p>Equivalent to calling {@code #getAnnotationAttributes(Annotation, boolean, boolean)}
     * with the {@code classValuesAsString} and {@code nestedAnnotationsAsMap} parameters
     * set to {@code false}.
     * <p>Note: This method actually returns an {@code com.ziyao.springframework.data.annotation.AnnotationAttributes} instance.
    ...
    /**
     * Retrieve the given annotation's attributes as a {@code Map}.
     * <p>Equivalent to calling {@code #getAnnotationAttributes(Annotation, boolean, boolean)}
     ...
     *                            compatibility with {@code com.ziyao.springframework.data.type.AnnotationMetadata})
    ...
    /**
     * Retrieve the given annotation's attributes as an {@code com.ziyao.springframework.data.annotation.AnnotationAttributes} map.
     * <p>This method provides fully recursive annotation reading capabilities on par with
     * the reflection-based {@code com.ziyao.springframework.data.type.StandardAnnotationMetadata}.
     *
     * @param annotation             the annotation to retrieve the attributes for
     * @param classValuesAsString    whether to convert Class references into Strings (for
     *                               compatibility with {@code com.ziyao.springframework.data.type.AnnotationMetadata})
     ...
     *                               {@code com.ziyao.springframework.data.annotation.AnnotationAttributes} maps (for compatibility with
     *                               {@code com.ziyao.springframework.data.type.AnnotationMetadata}) or to preserve them as
     *                               {@code Annotation} instances
     * @return the annotation attributes (a specialized Map) with attribute names as keys
     * and corresponding attribute values as values (never {@code null})
     * @since 3.1.1
     */
    public static com.ziyao.springframework.data.annotation.AnnotationAttributes getAnnotationAttributes(
    ...
    /**
     * Retrieve the given annotation's attributes as an {@code com.ziyao.springframework.data.annotation.AnnotationAttributes} map.
     * <p>Equivalent to calling {@code #getAnnotationAttributes(AnnotatedElement, Annotation, boolean, boolean)}
     * with the {@code classValuesAsString} and {@code nestedAnnotationsAsMap} parameters
     * set to {@code false}.
     *
    ...
    public static com.ziyao.springframework.data.annotation.AnnotationAttributes getAnnotationAttributes(
        ...
        return MergedAnnotation.from(annotatedElement, annotation)
                ...
                .asMap(mergedAnnotation ->
                        new com.ziyao.springframework.data.annotation.AnnotationAttributes(mergedAnnotation.getType(), true), adaptations);
    }
     ...
     * @since 4.3.2
     */
    public static void registerDefaultValues(com.ziyao.springframework.data.annotation.AnnotationAttributes attributes) {
    ...
    private static Map<String, DefaultValueHolder> computeDefaultValues(
        ...
        if (!methods.hasNestedAnnotation()) {
            ...
            com.ziyao.springframework.data.annotation.AnnotationAttributes attributes = MergedAnnotation.of(annotationType)
                    .asMap(annotation ->
                            new com.ziyao.springframework.data.annotation.AnnotationAttributes(annotation.getType(), true), Adapt.ANNOTATION_TO_MAP);
    ...
    /**
     * Post-process the supplied {@code com.ziyao.springframework.data.annotation.AnnotationAttributes}, preserving nested
     * annotations as {@code Annotation} instances.
     * <p>Specifically, this method enforces <em>attribute alias</em> semantics
     * for annotation attributes that are annotated with {@code com.ziyao.springframework.data.annotation.AliasFor @AliasFor}
    ...
    public static void postProcessAnnotationAttributes(@Nullable Object annotatedElement,
                                                       @Nullable com.ziyao.springframework.data.annotation.AnnotationAttributes attributes, boolean classValuesAsString) {
    ...
    private static Object getAttributeValueForMirrorResolution(Method attribute, Object attributes) {
        Object result = ((com.ziyao.springframework.data.annotation.AnnotationAttributes) attributes).get(attribute.getName());
    ...
    private static Object adaptValue(
        ...
        if (value instanceof Annotation) {
            return MergedAnnotation.from(annotatedElement, (Annotation) value).synthesize();
        }
        if (value instanceof Annotation[]) {
     ...
     * value cannot be retrieved due to an {@code com.ziyao.springframework.data.annotation.AnnotationConfigurationException},
    ...
    /**
     * Invoke the supplied annotation attribute {@code Method} on the supplied
     * {@code Annotation}.
     * <p>An attempt will first be made to invoke the method via the annotation's
     * {@code InvocationHandler} (if the annotation instance is a JDK dynamic proxy).
    ...
    /**
     * If the supplied throwable is an {@code com.ziyao.springframework.data.annotation.AnnotationConfigurationException},
    ...
    static void rethrowAnnotationConfigurationException(Throwable ex) {
        if (ex instanceof com.ziyao.springframework.data.annotation.AnnotationConfigurationException) {
            throw (com.ziyao.springframework.data.annotation.AnnotationConfigurationException) ex;
        }
    }

    /**
     * Handle the supplied annotation introspection exception.
     * <p>If the supplied exception is an {@code com.ziyao.springframework.data.annotation.AnnotationConfigurationException},
     * it will simply be thrown, allowing it to propagate to the caller, and
     * nothing will be logged.
     * <p>Otherwise, this method logs an introspection failure (in particular for
     * a {@code TypeNotPresentException}) before moving on, assuming nested
    ...
    /**
     * Retrieve the <em>default value</em> of the {@code value} attribute
     * of a single-element Annotation, given the {@code Class annotation type}.
     *
     ...
     * annotated with {@code com.ziyao.springframework.data.annotation.AliasFor @AliasFor}.
     *
     ...
     * @throws com.ziyao.springframework.data.annotation.AnnotationConfigurationException if invalid configuration of
     ...
     * {@code #synthesizeAnnotation(Map, Class, AnnotatedElement)},
     * supplying an empty map for the source attribute values and {@code null}
     * for the {@code AnnotatedElement}.
     *
     ...
     * that are annotated with {@code AliasFor @AliasFor}.
     ...
     * <p>Note that {@code AnnotationAttributes} is a specialized type of
     * {@code Map} that is an ideal candidate for this method's
     ...
     * type and populating it with {@codeplain #synthesizeAnnotation(Annotation,
    ...
    /**
     * Determine if the supplied {@code Annotation} has been <em>synthesized</em>

 ...
 */
package com.ziyao.springframework.data.mapping;
...
public interface PersistentEntity<T, P extends PersistentProperty<P>> extends Iterable<P> {
	 ...
	 *         {@link com.ziyao.springframework.data.mapping.model.EntityInstantiator} or handled by custom conversion
	 *         mechanisms entirely.
	 ...
	 *         customer {@link com.ziyao.springframework.data.mapping.model.EntityInstantiator} or handled by custom conversion
	 *         mechanisms entirely.
	 * @since 2.7
	 */
	@Nullable

 ...
 * repeatable annotations on {@code AnnotatedElement AnnotatedElements}.
 *
 ...
 * overrides, consider using {@code AnnotationUtils} instead.
 *
 ...
 * locally or {@codeplain java.lang.annotation.Inherited inherited}) or declared
 ...
 * {@code java.lang.annotation.Inherited @Inherited} annotation except that locally
...
public abstract class AnnotatedElementUtils {
    ...
    /**
     * Build an adapted {@code AnnotatedElement} for the given annotations,
     * typically for use with other methods on {@code AnnotatedElementUtils}.
     *
     ...
     * on the supplied {@code AnnotatedElement}.
     * <p>This method follows <em>get semantics</em> as described in the
     * {@codeplain AnnotatedElementUtils class-level javadoc}.
     *
     ...
     * {@code annotationName}) on the supplied {@code AnnotatedElement}.
     * <p>This method follows <em>get semantics</em> as described in the
     * {@codeplain AnnotatedElementUtils class-level javadoc}.
     *
     * @param element        the annotated element
    ...
    /**
     * Determine if the supplied {@code AnnotatedElement} is annotated with
    ...
    /**
     * Determine if the supplied {@code AnnotatedElement} is annotated with a
     ...
     * is <em>present</em> on the supplied {@code AnnotatedElement} or
     * within the annotation hierarchy <em>above</em> the specified element.
     * <p>If this method returns {@code true}, then {@code #getMergedAnnotationAttributes}
     ...
     * <em>present</em> on the supplied {@code AnnotatedElement} or within the
     ...
     * <p>{@code com.ziyao.springframework.data.annotation.AliasFor @AliasFor} semantics are fully supported, both
     * within a single annotation and within the annotation hierarchy.
     * <p>This method delegates to {@code #getMergedAnnotationAttributes(AnnotatedElement, String)}.
     *
     * @param element        the annotated element
     * @param annotationType the annotation type to find
     ...
     * <p>{@code com.ziyao.springframework.data.annotation.AliasFor @AliasFor} semantics are fully supported, both
     * within a single annotation and within the annotation hierarchy.
     * <p>This method delegates to {@code #getMergedAnnotationAttributes(AnnotatedElement, String, boolean, boolean)},
     ...
     * of the same name from higher levels, and {@code com.ziyao.springframework.data.annotation.AliasFor @AliasFor} semantics are
     * fully supported, both within a single annotation and within the annotation hierarchy.
     * <p>In contrast to {@code #getAllAnnotationAttributes}, the search algorithm used by
     ...
     * {@code annotationType}.
     * <p>{@code com.ziyao.springframework.data.annotation.AliasFor @AliasFor} semantics are fully supported, both within a
     ...
     * via {@code java.lang.annotation.Repeatable}.
     * <p>{@code com.ziyao.springframework.data.annotation.AliasFor @AliasFor} semantics are fully supported, both within a
     * single annotation and within annotation hierarchies.
     * <p>This method follows <em>get semantics</em> as described in the
     * {@codeplain AnnotatedElementUtils class-level javadoc}.
     ...
     * support such a use case, favor {@code #getMergedRepeatableAnnotations(AnnotatedElement, Class)}
     * over this method or alternatively use the {@code MergedAnnotations} API
     * directly in conjunction with {@code RepeatableContainers} that are
     * {@codeplain RepeatableContainers#and(Class, Class) composed} to support
     ...
     * {@code AnnotatedElement} and store the results in a {@code MultiValueMap}.
     * <p>Note: in contrast to {@code #getMergedAnnotationAttributes(AnnotatedElement, String)},
     ...
     * @param element        the annotated element
     * @param annotationName the fully qualified class name of the annotation type to find
     * @return a {@code MultiValueMap} keyed by attribute name, containing the annotation
     ...
     * the supplied {@code AnnotatedElement} and store the results in a
     * {@code MultiValueMap}.
     * <p>Note: in contrast to {@code #getMergedAnnotationAttributes(AnnotatedElement, String)},
     * this method does <em>not</em> support attribute overrides.
     * <p>This method follows <em>get semantics</em> as described in the
    ...
    /**
     * Determine if an annotation of the specified {@code annotationType}
     * is <em>available</em> on the supplied {@code AnnotatedElement} or
     * within the annotation hierarchy <em>above</em> the specified element.
     * <p>If this method returns {@code true}, then {@code #findMergedAnnotationAttributes}
     * will return a non-null value.
     ...
     * {@code com.ziyao.springframework.data.annotation.AliasFor @AliasFor} semantics are fully supported, both
     * within a single annotation and within the annotation hierarchy.
     * <p>In contrast to {@code #getAllAnnotationAttributes}, the search algorithm
     ...
     * {@code com.ziyao.springframework.data.annotation.AliasFor @AliasFor} semantics are fully supported, both
     * within a single annotation and within the annotation hierarchy.
     * <p>In contrast to {@code #getAllAnnotationAttributes}, the search
     ...
     * hierarchy and synthesize the results back into an annotation of the specified
     * {@code annotationType}.
     * <p>{@code AliasFor @AliasFor} semantics are fully supported, both within a
     * single annotation and within annotation hierarchies.
     * <p>This method follows <em>find semantics</em> as described in the
     * {@codeplain AnnotatedElementUtils class-level javadoc}.
     * <p><strong>WARNING</strong>: if the supplied {@code containerType} is not
     ...
     * prevents the search from finding repeatable annotations declared as
     * meta-annotations on other types of repeatable annotations. If you need to
     * support such a use case, favor {@code #findMergedRepeatableAnnotations(AnnotatedElement, Class)}
     * over this method or alternatively use the {@code MergedAnnotations} API
     * directly in conjunction with {@code RepeatableContainers} that are
     * {@codeplain RepeatableContainers#and(Class, Class) composed} to support
     * multiple repeatable annotation types.
    ...
    /**
     * Adapted {@code AnnotatedElement} that holds specific annotations.
     */

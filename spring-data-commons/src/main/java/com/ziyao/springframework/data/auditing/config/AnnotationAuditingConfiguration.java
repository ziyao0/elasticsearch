 ...
 */
package com.ziyao.springframework.data.auditing.config;
...
public class AnnotationAuditingConfiguration implements AuditingConfiguration {
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.auditing.config.AuditingConfiguration#getAuditorAwareRef()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.auditing.config.AuditingConfiguration#isSetDates()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.auditing.config.AuditingConfiguration#getDateTimeProviderRef()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.auditing.config.AuditingConfiguration#isModifyOnCreate()
	 */
	@Override

 ...
 * @author Mark Paluch
 * @deprecated since 2.3, use {@link com.ziyao.springframework.data.mapping.model.EntityInstantiators} instead.
 */
@Deprecated
public class EntityInstantiators extends com.ziyao.springframework.data.mapping.model.EntityInstantiators {
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.mapping.model.EntityInstantiators#getInstantiatorFor(com.ziyao.springframework.data.mapping.PersistentEntity)
	 */
	@Override
	...
	private static Map<Class<?>, com.ziyao.springframework.data.mapping.model.EntityInstantiator> adaptFromLegacy(

...
public interface MappingContext<E extends PersistentEntity<?, P>, P extends PersistentProperty<P>> {
	 ...
	 *
	 * @see com.ziyao.springframework.data.mapping.model.SimpleTypeHolder#isSimpleType(Class)
	 ...
	 *         {@link com.ziyao.springframework.data.mapping.model.SimpleTypeHolder#isSimpleType(Class)}).
	 */
	@Nullable

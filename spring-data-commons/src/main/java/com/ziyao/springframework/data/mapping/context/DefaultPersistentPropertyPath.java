...
import com.ziyao.springframework.data.mapping.PersistentPropertyPath;
...
class DefaultPersistentPropertyPath<P extends PersistentProperty<P>> implements PersistentPropertyPath<P> {
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.mapping.context.PersistentPropertyPath#toDotPath()
	 */
	@Nullable
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.mapping.context.PersistentPropertyPath#toDotPath(org.springframework.core.convert.converter.Converter)
	 */
	@Nullable
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.mapping.context.PersistentPropertyPath#toPath(java.lang.String)
	 */
	@Nullable
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.mapping.context.PersistentPropertyPath#toPath(java.lang.String, org.springframework.core.convert.converter.Converter)
	 */
	@Nullable
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.mapping.context.PersistentPropertyPath#getLeafProperty()
	 */
	@Nullable
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.mapping.context.PersistentPropertyPath#getBaseProperty()
	 */
	@Nullable
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.mapping.context.PersistentPropertyPath#isBasePathOf(com.ziyao.springframework.data.mapping.context.PersistentPropertyPath)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.mapping.context.PersistentPropertyPath#getExtensionForBaseOf(com.ziyao.springframework.data.mapping.context.PersistentPropertyPath)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.mapping.context.PersistentPropertyPath#getParentPath()
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.mapping.context.PersistentPropertyPath#getLength()
	 */

...
public class SpelAwareProxyProjectionFactory extends ProxyProjectionFactory implements BeanFactoryAware {
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.projection.ProxyProjectionFactory#createProjectionInformation(java.lang.Class)
	 */
	@Override
	...
	protected static class SpelAwareProjectionInformation extends DefaultProjectionInformation {
		...
		/*
		 * (non-Javadoc)
		 * @see com.ziyao.springframework.data.projection.DefaultProjectionInformation#isInputProperty(java.beans.PropertyDescriptor)
		 */
		@Override

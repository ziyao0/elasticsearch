...
/**
 * Abstract base class for {@code MergedAnnotation} implementations.
 *
...
abstract class AbstractMergedAnnotation<A extends Annotation> implements MergedAnnotation<A> {
    ...
    public <E extends Enum<E>> E[] getEnumArray(String attributeName, Class<E> type) {
        Assert.notNull(type, "Type must not be null");
        return (E[]) getRequiredAttributeValue(attributeName, java.lang.reflect.Array.newInstance(type, 0).getClass());
    }
    ...
    @Override
    public com.ziyao.springframework.data.annotation.AnnotationAttributes asAnnotationAttributes(Adapt... adaptations) {
        return asMap(mergedAnnotation -> new com.ziyao.springframework.data.annotation.AnnotationAttributes(mergedAnnotation.getType()), adaptations);
    }
     ...
     * @param type          the type to return (see {@code MergedAnnotation} class
     ...
     * <p>Consult the documentation for {@code MergedAnnotation#synthesize()}

...
import com.ziyao.springframework.data.mapping.AccessOptions.GetOptions;
import com.ziyao.springframework.data.mapping.AccessOptions.GetOptions.GetNulls;
import com.ziyao.springframework.data.mapping.AccessOptions.SetOptions;
import com.ziyao.springframework.data.mapping.AccessOptions.SetOptions.SetNulls;
...
import static com.ziyao.springframework.data.mapping.AccessOptions.SetOptions.SetNulls.*;
...
class SimplePersistentPropertyPathAccessor<T> implements PersistentPropertyPathAccessor<T> {
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.mapping.PersistentPropertyAccessor#getBean()
	 */
	@Override
	public T getBean() {
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.mapping.PersistentPropertyAccessor#getProperty(com.ziyao.springframework.data.mapping.PersistentProperty)
	 */
	@Nullable
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.mapping.PersistentPropertyPathAccessor#getProperty(com.ziyao.springframework.data.mapping.PersistentPropertyPath)
	 */
	@Nullable
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.mapping.PersistentPropertyPathAccessor#getProperty(com.ziyao.springframework.data.mapping.PersistentPropertyPath, com.ziyao.springframework.data.mapping.PersistentPropertyPathAccessor.Options)
	 */
	@Nullable
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.mapping.PersistentPropertyAccessor#setProperty(com.ziyao.springframework.data.mapping.PersistentProperty, java.lang.Object)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.mapping.PersistentPropertyPathAccessor#setProperty(com.ziyao.springframework.data.mapping.PersistentPropertyPath, java.lang.Object)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.mapping.model.ConvertingPropertyAccessor#setProperty(com.ziyao.springframework.data.mapping.PersistentPropertyPath, java.lang.Object)
	 */

 ...
 */
package com.ziyao.springframework.data.repository.init;
...
import com.ziyao.springframework.data.repository.support.Repositories;
...
public class ResourceReaderRepositoryPopulator implements RepositoryPopulator, ApplicationEventPublisherAware {
    ...
    /*
     * (non-Javadoc)
     * @see com.ziyao.springframework.data.repository.init.RepositoryPopulator#initialize()
     */

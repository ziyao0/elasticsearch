...
import com.ziyao.springframework.data.domain.AfterDomainEventPublication;
import com.ziyao.springframework.data.domain.DomainEvents;
...
public class EventPublishingRepositoryProxyPostProcessor implements RepositoryProxyPostProcessor {
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.repository.core.support.RepositoryProxyPostProcessor#postProcess(org.springframework.aop.framework.ProxyFactory, com.ziyao.springframework.data.repository.core.RepositoryInformation)
	 */
	@Override

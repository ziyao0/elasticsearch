...
class ParameterizedTypeInformation<T> extends ParentTypeAwareTypeInformation<T> {
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.util.TypeDiscoverer#doGetMapValueType()
	 */
	@Override
	@Nullable
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.util.TypeDiscoverer#getTypeParameters()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.util.TypeDiscoverer#isAssignableFrom(com.ziyao.springframework.data.util.TypeInformation)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.util.TypeDiscoverer#doGetComponentType()
	 */
	@Override
	@Nullable
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.util.TypeDiscoverer#specialize(com.ziyao.springframework.data.util.ClassTypeInformation)
	 */
	@Override

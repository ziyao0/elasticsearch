...
import com.ziyao.springframework.data.annotation.MergedAnnotations.Search;
...
abstract class AnnotationsScanner {
     ...
     * @return the result of {@code AnnotationsProcessor#finish(Object)}
     */
    @Nullable
    ...
    private static <C, R> R process(C context, AnnotatedElement source,
        ...
        if (source instanceof Class<?>) {
            return processClass(context, (Class<?>) source, searchStrategy, searchEnclosingClass, processor);
        }
    ...
    private static <C, R> R processClass(C context, Class<?> source, SearchStrategy searchStrategy,
        ...
        switch (searchStrategy) {
            ...
            case SUPERCLASS:
                return processClassHierarchy(context, source, processor, false, Search.never);
            case TYPE_HIERARCHY:
                return processClassHierarchy(context, source, processor, true, searchEnclosingClass);
        }
        return null;
    }
    ...
    private static <C, R> R processClassInheritedAnnotations(C context, Class<?> source,
        ...
        try {
            ...
            com.ziyao.springframework.data.annotation.AnnotationUtils.handleIntrospectionFailure(source, ex);
        }
        return null;
    }
    ...
    private static <C, R> R processMethodHierarchy(C context, int[] aggregateIndex,
        ...
        try {
            ...
            com.ziyao.springframework.data.annotation.AnnotationUtils.handleIntrospectionFailure(rootMethod, ex);
        }
        return null;
    }

...
import com.ziyao.springframework.data.mapping.PropertyReferenceException;
...
public class QuerydslBindings {
	...
	public class AliasingPathBinder<P extends Path<? extends T>, T> extends PathBinder<P, T> {
		...
		/*
		 * (non-Javadoc)
		 * @see com.ziyao.springframework.data.querydsl.binding.QuerydslBindings.PathBinder#registerBinding(com.ziyao.springframework.data.querydsl.binding.QuerydslBindings.PathAndBinding)
		 */
		@Override
		protected void registerBinding(PathAndBinding<P, T> binding) {

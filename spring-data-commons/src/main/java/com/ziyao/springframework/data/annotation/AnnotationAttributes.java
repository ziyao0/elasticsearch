...
/**
 * {@code LinkedHashMap} subclass representing annotation attribute
 * <em>key-value</em> pairs as read by {@code AnnotationUtils},
 * {@code com.ziyao.springframework.data.annotation.AnnotatedElementUtils}, and Spring's reflection- and ASM-based
 * {@code org.springframework.core.type.AnnotationMetadata} implementations.
 *
...
public class AnnotationAttributes extends LinkedHashMap<String, Object> {
    ...
    /**
     * Create a new, empty {@code AnnotationAttributes} instance.
     */
    ...
    /**
     * Create a new, empty {@code AnnotationAttributes} instance with the
    ...
    /**
     * Create a new {@code AnnotationAttributes} instance, wrapping the provided
    ...
    /**
     * Create a new, empty {@code AnnotationAttributes} instance for the
     ...
     * {@code AnnotationAttributes} instance for the specified
     * {@code annotationType}.
     *
     * @param annotationType the type of annotation represented by this
     *                       {@code AnnotationAttributes} instance; never {@code null}
    ...
    /**
     * Get the {@code AnnotationAttributes} stored under the specified
     * {@code attributeName}.
     * <p>Note: if you expect an actual annotation, invoke
     * {@code #getAnnotation(String, Class)} instead.
     *
     * @param attributeName the name of the attribute to get;
     *                      never {@code null} or empty
    ...
    /**
     * Get the array of {@code AnnotationAttributes} stored under the specified
     * {@code attributeName}.
     * <p>If the value stored under the specified {@code attributeName} is
     ...
     * {@code #getAnnotationArray(String, Class)} instead.
     *
     * @param attributeName the name of the attribute to get;
     *                      never {@code null} or empty
    ...
    public <A extends Annotation> A[] getAnnotationArray(String attributeName, Class<A> annotationType) {
        Class<?> clazz = Array.newInstance(annotationType, 0).getClass();
        return (A[]) getRequiredAttribute(attributeName, clazz);
    }
    ...
    /**
     * Return an {@code AnnotationAttributes} instance based on the given map.
     ...
     * to the {@code #AnnotationAttributes(Map)} constructor.
     *
     * @param map original source of annotation attribute <em>key-value</em> pairs
     */
    @Nullable

...
public class ConvertingPropertyAccessor<T> extends SimplePersistentPropertyPathAccessor<T> {
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.mapping.PersistentPropertyAccessor#setProperty(com.ziyao.springframework.data.mapping.PersistentPropertyPath, java.lang.Object)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.mapping.model.SimplePersistentPropertyPathAccessor#getTypedProperty(com.ziyao.springframework.data.mapping.PersistentProperty, java.lang.Class)
	 */
	@Nullable
	@Override

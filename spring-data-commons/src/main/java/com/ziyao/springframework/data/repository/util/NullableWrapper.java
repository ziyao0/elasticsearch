 ...
 * @deprecated since 2.4, use {@link com.ziyao.springframework.data.util.NullableWrapper} instead.
 */
@Deprecated
public class NullableWrapper extends com.ziyao.springframework.data.util.NullableWrapper {

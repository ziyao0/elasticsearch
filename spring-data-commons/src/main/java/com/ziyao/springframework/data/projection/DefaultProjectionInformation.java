...
import com.ziyao.springframework.data.type.MethodsMetadata;
import com.ziyao.springframework.data.type.classreading.MethodsMetadataReader;
import com.ziyao.springframework.data.type.classreading.MethodsMetadataReaderFactory;
...
class DefaultProjectionInformation implements ProjectionInformation {
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.projection.ProjectionInformation#getType()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.projection.ProjectionInformation#getInputProperties()
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.projection.ProjectionInformation#isDynamic()
	 */
	@Override

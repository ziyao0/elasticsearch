...
/**
 * {@code InvocationHandler} for an {@code Annotation} that Spring has
...
final class SynthesizedMergedAnnotationInvocationHandler<A extends Annotation> implements InvocationHandler {
    ...
    /**
     * See {@code Annotation#equals(Object)} for a definition of the required algorithm.
     *
    ...
    private boolean annotationEquals(Object other) {
        ...
        for (int i = 0; i < this.attributes.size(); i++) {
            ...
            Object otherValue = com.ziyao.springframework.data.annotation.AnnotationUtils.invokeAnnotationMethod(attribute, other);
    ...
    /**
     * See {@code Annotation#hashCode()} for a definition of the required algorithm.
     */

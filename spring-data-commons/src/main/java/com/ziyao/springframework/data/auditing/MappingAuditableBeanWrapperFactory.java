 ...
 */
package com.ziyao.springframework.data.auditing;

import org.springframework.core.convert.ConversionService;
import com.ziyao.springframework.data.annotation.CreatedBy;
import com.ziyao.springframework.data.annotation.CreatedDate;
import com.ziyao.springframework.data.annotation.LastModifiedBy;
import com.ziyao.springframework.data.annotation.LastModifiedDate;
import com.ziyao.springframework.data.domain.Auditable;
import com.ziyao.springframework.data.mapping.*;
import com.ziyao.springframework.data.mapping.AccessOptions.SetOptions;
import com.ziyao.springframework.data.mapping.AccessOptions.SetOptions.Propagation;
import com.ziyao.springframework.data.mapping.context.MappingContext;
import com.ziyao.springframework.data.mapping.context.PersistentEntities;
...
public class MappingAuditableBeanWrapperFactory extends DefaultAuditableBeanWrapperFactory {
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.auditing.AuditableBeanWrapperFactory#getBeanWrapperFor(java.lang.Object)
	 */
	@Override
	...
	static class MappingMetadataAuditableBeanWrapper<T> extends DateConvertingAuditableBeanWrapper<T> {
		...
		/*
		 * (non-Javadoc)
		 * @see com.ziyao.springframework.data.auditing.AuditableBeanWrapper#setCreatedBy(java.lang.Object)
		 */
		@Override
		...
		/*
		 * (non-Javadoc)
		 * @see com.ziyao.springframework.data.auditing.AuditableBeanWrapper#setCreatedDate(java.util.Optional)
		 */
		@Override
		...
		/*
		 * (non-Javadoc)
		 * @see com.ziyao.springframework.data.auditing.AuditableBeanWrapper#setLastModifiedBy(java.util.Optional)
		 */
		@Override
		...
		/*
		 * (non-Javadoc)
		 * @see com.ziyao.springframework.data.auditing.AuditableBeanWrapper#getLastModifiedDate()
		 */
		@Override
		...
		/*
		 * (non-Javadoc)
		 * @see com.ziyao.springframework.data.auditing.AuditableBeanWrapper#setLastModifiedDate(java.util.Optional)
		 */
		@Override
		...
		/*
		 * (non-Javadoc)
		 * @see com.ziyao.springframework.data.auditing.AuditableBeanWrapper#getBean()
		 */
		@Override
		public T getBean() {

...
import com.ziyao.springframework.data.annotation.PersistenceCreator;
...
public interface PreferredConstructorDiscoverer<T, P extends PersistentProperty<P>> {
	...
	enum Discoverers {
		...
		DEFAULT {
			...
			/*
			 * (non-Javadoc)
			 * @see com.ziyao.springframework.data.mapping.model.PreferredConstructorDiscoverers#discover(com.ziyao.springframework.data.util.TypeInformation, com.ziyao.springframework.data.mapping.PersistentEntity)
			 */
			@Nullable
			@Override

...
import com.ziyao.springframework.data.repository.config.CustomRepositoryImplementationDetector;
import com.ziyao.springframework.data.repository.config.RepositoryFragmentConfiguration;
...
import com.ziyao.springframework.data.repository.core.support.RepositoryFragment;
...
public abstract class CdiRepositoryBean<T> implements Bean<T>, PassivationCapable {
	...
	/**
	 * Try to lookup a custom implementation for a {@link com.ziyao.springframework.data.repository.Repository}. Can only be

...
class PersistentPropertyPathFactory<E extends PersistentEntity<?, P>, P extends PersistentProperty<P>> {
	...
	static class DefaultPersistentPropertyPaths<T, P extends PersistentProperty<P>>
		...
		/*
		 * (non-Javadoc)
		 * @see com.ziyao.springframework.data.mapping.PersistentPropertyPaths#getFirst()
		 */
		@Override
		...
		/*
		 * (non-Javadoc)
		 * @see com.ziyao.springframework.data.mapping.PersistentPropertyPaths#contains(java.lang.String)
		 */
		@Override
		...
		/*
		 * (non-Javadoc)
		 * @see com.ziyao.springframework.data.mapping.PersistentPropertyPaths#contains(com.ziyao.springframework.data.mapping.PropertyPath)
		 */
		@Override
		...
		/*
		 * (non-Javadoc)
		 * @see com.ziyao.springframework.data.mapping.PersistentPropertyPaths#dropPathIfSegmentMatches(java.util.function.Predicate)
		 */
		@Override

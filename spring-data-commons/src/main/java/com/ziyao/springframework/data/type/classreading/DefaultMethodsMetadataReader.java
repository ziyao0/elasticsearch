 ...
 */
package com.ziyao.springframework.data.type.classreading;
...
/**
 * {@link MethodsMetadataReader} implementation based on an ASM {@link ClassReader}.
 *
 * @author Mark Paluch
...
class DefaultMethodsMetadataReader implements MethodsMetadataReader {
	...
	private static class MethodsMetadataReadingVisitor extends AnnotationMetadataReadingVisitor
		...
		/*
		 * (non-Javadoc)
		 * @see com.ziyao.springframework.data.util.MethodsMetadata#getMethods()
		 */
		@Override
		...
		/*
		 * (non-Javadoc)
		 * @see com.ziyao.springframework.data.util.MethodsMetadata#getMethods(String)
		 */
		@Override

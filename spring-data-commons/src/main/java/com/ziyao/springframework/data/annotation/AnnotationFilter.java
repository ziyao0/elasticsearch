 ...
 *
 * <p>Note that the {@code MergedAnnotations} model (which this interface has been
 * designed for) always ignores lang annotations according to the {@code #PLAIN}
...
public interface AnnotationFilter {
    ...
    /**
     * {@code AnnotationFilter} that matches annotations in the
     * {@code java.lang} and {@code org.springframework.lang} packages
     * and their subpackages.
     * <p>This is the default filter in the {@code MergedAnnotations} model.
     */
    ...
    /**
     * {@code AnnotationFilter} that always matches and can be used when no
    ...
    /**
     * {@code AnnotationFilter} that never matches and can be used when no
     * filtering is needed (allowing for any annotation types to be present).
     *
     * @see #PLAIN
     * @deprecated as of 5.2.6 since the {@code MergedAnnotations} model
     * always ignores lang annotations according to the {@code #PLAIN} filter
    ...
    /**
     * Create a new {@code AnnotationFilter} that matches annotations in the
     * specified packages.
     *
     * @param packages the annotation packages that should match
     * @return a new {@code AnnotationFilter} instance
     */

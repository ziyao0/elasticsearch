...
import com.ziyao.springframework.data.mapping.PropertyPath;
import com.ziyao.springframework.data.querydsl.EntityPathResolver;
...
class PropertyPathInformation implements PathInformation {
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.querydsl.binding.PathInformation#getRootParentType()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.querydsl.binding.PathInformation#getLeafType()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.querydsl.binding.PathInformation#getLeafParentType()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.querydsl.binding.PathInformation#getLeafProperty()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.querydsl.binding.PathInformation#getLeafPropertyDescriptor()
	 */
	@Nullable
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.querydsl.binding.PathInformation#toDotPath()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.querydsl.binding.PathInformation#reifyPath(com.ziyao.springframework.data.querydsl.EntityPathResolver)
	 */
	@Override
	...
	private static Path<?> reifyPath(EntityPathResolver resolver, PropertyPath path, Optional<Path<?>> base) {
		...
		return map.orElseGet(() -> {
			...
			Field field = com.ziyao.springframework.data.util.ReflectionUtils.findRequiredField(entityPath.getClass(),
					path.getSegment());

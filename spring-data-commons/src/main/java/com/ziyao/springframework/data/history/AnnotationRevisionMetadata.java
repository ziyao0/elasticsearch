 ...
 */
package com.ziyao.springframework.data.history;

import com.ziyao.springframework.data.util.AnnotationDetectionFieldCallback;
import com.ziyao.springframework.data.util.AnnotationDetectionMethodCallback;
...
public class AnnotationRevisionMetadata<N extends Number & Comparable<N>> implements RevisionMetadata<N> {
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.repository.history.RevisionMetadata#getRevisionNumber()
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.history.RevisionMetadata#getRevisionDate()
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.repository.history.RevisionMetadata#getDelegate()
	 */

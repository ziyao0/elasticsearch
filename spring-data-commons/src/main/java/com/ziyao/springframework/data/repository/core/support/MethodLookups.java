...
import com.ziyao.springframework.data.repository.core.support.MethodLookup.MethodPredicate;
...
interface MethodLookups {
    ...
    class RepositoryAwareMethodLookup implements MethodLookup {
        ...
        private static final TypeVariable<Class<Repository>>[] PARAMETERS = Repository.class
                .getTypeParameters();
        ...
        /*
         * (non-Javadoc)
         * @see com.ziyao.springframework.data.repository.core.support.MethodLookup#getLookups()
         */
        @Override
    ...
    class ReactiveTypeInteropMethodLookup extends RepositoryAwareMethodLookup {
        ...
        /*
         * (non-Javadoc)
         * @see com.ziyao.springframework.data.repository.core.support.MethodLookups.RepositoryAwareMethodLookup#getLookups()
         */
        @Override
        public List<MethodPredicate> getLookups() {
        ...
        private Predicate<ParameterOverrideCriteria> matchParameterOrComponentType(Class<?> repositoryInterface) {
            ...
            return (parameterCriteria) -> {
                MethodParameter parameter = parameterCriteria.getDeclared();
                Class<?> parameterType = resolveParameterType(parameter, repositoryInterface);
         ...
         * converted into a different wrapper. Usually {@link } to {@link org.reactivestreams.Publisher}
         * conversion.
         *
         * @return
         */
        private static Predicate<ParameterOverrideCriteria> wrapperConversionMatch() {
            ...
            return (parameterCriteria) -> {
                if (isNonUnwrappingWrapper(parameterCriteria.getBaseType())) {
                    parameterCriteria.getDeclaredType();
                }//
//
                return false;
            };

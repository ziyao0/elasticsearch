...
public class ExtensionAwareQueryMethodEvaluationContextProvider implements QueryMethodEvaluationContextProvider {
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.repository.query.QueryMethodEvaluationContextProvider#getEvaluationContext(com.ziyao.springframework.data.repository.query.Parameters, java.lang.Object[])
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.repository.query.QueryMethodEvaluationContextProvider#getEvaluationContext(com.ziyao.springframework.data.repository.query.Parameters, java.lang.Object[], ExpressionDependencies)
	 */
	@Override
	public <T extends Parameters<?, ?>> EvaluationContext getEvaluationContext(T parameters, Object[] parameterValues,

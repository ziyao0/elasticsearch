...
public class CustomCollections {
    ...
    static class VavrCollections implements CustomCollectionRegistrar {
        ...
        /*
         * (non-Javadoc)
         * @see com.ziyao.springframework.data.util.CustomCollectionRegistrar#isAvailable()
         */
        @Override
        ...
        /*
         * (non-Javadoc)
         * @see com.ziyao.springframework.data.util.CustomCollectionRegistrar#getMapTypes()
         */
        @Override
        ...
        /*
         * (non-Javadoc)
         * @see com.ziyao.springframework.data.util.CustomCollectionRegistrar#getCollectionTypes()
         */
        @Override
        ...
        /*
         * (non-Javadoc)
         * @see com.ziyao.springframework.data.util.CustomCollectionRegistrar#getAllowedPaginationReturnTypes()
         */
        @Override
        ...
        /*
         * (non-Javadoc)
         * @see com.ziyao.springframework.data.util.CustomCollectionRegistrar#registerConvertersIn(org.springframework.core.convert.converter.ConverterRegistry)
         */
        @Override
        ...
        /*
         * (non-Javadoc)
         * @see com.ziyao.springframework.data.util.CustomCollectionRegistrar#toJavaNativeCollection()
         */
        @Override

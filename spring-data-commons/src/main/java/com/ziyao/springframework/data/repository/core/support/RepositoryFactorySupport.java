...
import com.ziyao.springframework.data.metrics.ApplicationStartup;
import com.ziyao.springframework.data.metrics.StartupStep;
import com.ziyao.springframework.data.projection.DefaultMethodInvokingMethodInterceptor;
import com.ziyao.springframework.data.projection.ProjectionFactory;
import com.ziyao.springframework.data.projection.SpelAwareProxyProjectionFactory;
import com.ziyao.springframework.data.repository.Repository;
...
import com.ziyao.springframework.data.repository.core.support.RepositoryComposition.RepositoryFragments;
import com.ziyao.springframework.data.repository.core.support.RepositoryInvocationMulticaster.DefaultRepositoryInvocationMulticaster;
import com.ziyao.springframework.data.repository.core.support.RepositoryInvocationMulticaster.NoOpRepositoryInvocationMulticaster;
...
import com.ziyao.springframework.data.repository.query.QueryMethod;
...
import com.ziyao.springframework.data.repository.util.QueryExecutionConverters;
...
public abstract class RepositoryFactorySupport implements BeanClassLoaderAware, BeanFactoryAware {
    ...
    private ApplicationStartup getStartup() {
        ...
        try {
            ...
            return beanFactory != null ? beanFactory.getBean(ApplicationStartup.class)
    ...
    static class ImplementationMethodExecutionInterceptor implements MethodInterceptor {
        ...
        public Object invoke(@SuppressWarnings("null") MethodInvocation invocation) throws Throwable {
            ...
            try {
                ...
                com.ziyao.springframework.data.repository.util.ClassUtils.unwrapReflectionException(e);
            }
    ...
    private static class QueryCollectingQueryCreationListener implements QueryCreationListener<RepositoryQuery> {
        ...
        /* (non-Javadoc)
         * @see com.ziyao.springframework.data.repository.core.support.QueryCreationListener#onCreation(com.ziyao.springframework.data.repository.query.RepositoryQuery)
         */
        @Override
    ...
    static class RepositoryValidator {
        ...
        static {
            ...
            com.ziyao.springframework.data.repository.util.ClassUtils.ifPresent(
                    "com.ziyao.springframework.data.querydsl.QuerydslPredicateExecutor", RepositoryValidator.class.getClassLoader(),
                    it -> {
                        WELL_KNOWN_EXECUTORS.put(it, "Querydsl");
                    });

            com.ziyao.springframework.data.repository.util.ClassUtils.ifPresent(
                    "com.ziyao.springframework.data.querydsl.ReactiveQuerydslPredicateExecutor",
                    RepositoryValidator.class.getClassLoader(), it -> {
                        WELL_KNOWN_EXECUTORS.put(it, "Reactive Querydsl");
                    });

            com.ziyao.springframework.data.repository.util.ClassUtils.ifPresent(
                    "com.ziyao.springframework.data.repository.query.QueryByExampleExecutor",
                    RepositoryValidator.class.getClassLoader(), it -> {
                        WELL_KNOWN_EXECUTORS.put(it, "Query by Example");
                    });

            com.ziyao.springframework.data.repository.util.ClassUtils.ifPresent(
                    "com.ziyao.springframework.data.repository.query.ReactiveQueryByExampleExecutor",
                    RepositoryValidator.class.getClassLoader(), it -> {

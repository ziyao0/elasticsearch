 ...
 */
package com.ziyao.springframework.data.repository.util;
...
import com.ziyao.springframework.data.domain.Slice;
import com.ziyao.springframework.data.geo.GeoResults;
import com.ziyao.springframework.data.util.NullableWrapper;
...
public abstract class QueryExecutionConverters {
	...
	private static abstract class AbstractWrapperTypeConverter implements GenericConverter {
		...
		public final Object convert(@Nullable Object source, TypeDescriptor sourceType, TypeDescriptor targetType) {
			...
			com.ziyao.springframework.data.util.NullableWrapper wrapper = (NullableWrapper) source;
	...
	private static class NullableWrapperToFutureConverter extends AbstractWrapperTypeConverter {
		...
		/*
		 * (non-Javadoc)
		 * @see com.ziyao.springframework.data.repository.util.QueryExecutionConverters.AbstractWrapperTypeConverter#wrap(java.lang.Object)
		 */
		@Override

...
import com.ziyao.springframework.data.repository.util.TxUtils;
...
public abstract class TransactionalRepositoryFactoryBeanSupport<T extends Repository<S, ID>, S, ID>
	 ...
	 *
	 * @see com.ziyao.springframework.data.repository.core.support.RepositoryFactoryBeanSupport #createRepositoryFactory()
	 */
	@Override

 ...
 */
package com.ziyao.springframework.data.geo;

import com.ziyao.springframework.data.domain.Page;
import com.ziyao.springframework.data.domain.PageImpl;
...
public class GeoPage<T> extends PageImpl<GeoResult<T>> {
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.domain.PageImpl#equals(java.lang.Object)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.domain.PageImpl#hashCode()
	 */
	@Override
	public int hashCode() {

...
class BeanWrapper<T> implements PersistentPropertyAccessor<T> {
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.mapping.PersistentPropertyAccessor#setProperty(com.ziyao.springframework.data.mapping.PersistentProperty, java.util.Optional)
	 */

...
import com.ziyao.springframework.data.repository.PagingAndSortingRepository;
...
class PagingAndSortingRepositoryInvoker extends CrudRepositoryInvoker {
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.repository.support.CrudRepositoryInvoker#invokeSortedFindAll(java.util.Optional)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.repository.support.CrudRepositoryInvoker#invokePagedFindAll(java.util.Optional)
	 */
	@Override

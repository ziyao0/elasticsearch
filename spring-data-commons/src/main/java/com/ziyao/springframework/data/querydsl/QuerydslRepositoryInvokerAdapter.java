 ...
 */
package com.ziyao.springframework.data.querydsl;

import com.querydsl.core.types.Predicate;
import com.ziyao.springframework.data.domain.Pageable;
import com.ziyao.springframework.data.domain.Sort;
import com.ziyao.springframework.data.repository.support.RepositoryInvoker;
...
public class QuerydslRepositoryInvokerAdapter implements RepositoryInvoker {
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.repository.support.RepositoryInvoker#invokePagedFindAll(com.ziyao.springframework.data.domain.Pageable)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.repository.support.RepositoryInvoker#invokeSortedFindAll(com.ziyao.springframework.data.domain.Sort)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.repository.support.RepositoryInvocationInformation#hasDeleteMethod()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.repository.support.RepositoryInvocationInformation#hasFindAllMethod()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.repository.support.RepositoryInvocationInformation#hasFindOneMethod()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.repository.support.RepositoryInvocationInformation#hasSaveMethod()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.repository.support.RepositoryInvoker#invokeQueryMethod(java.lang.reflect.Method, org.springframework.util.MultiValueMap, com.ziyao.springframework.data.domain.Pageable, com.ziyao.springframework.data.domain.Sort)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.repository.support.RepositoryInvoker#invokeSave(java.lang.Object)
	 */
	@Override

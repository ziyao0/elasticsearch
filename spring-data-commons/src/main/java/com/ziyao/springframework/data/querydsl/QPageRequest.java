...
import com.ziyao.springframework.data.domain.AbstractPageRequest;
import com.ziyao.springframework.data.domain.PageRequest;
...
public class QPageRequest extends AbstractPageRequest {
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.domain.AbstractPageRequest#next()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.domain.AbstractPageRequest#previous()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.domain.AbstractPageRequest#first()
	 */
	@Override

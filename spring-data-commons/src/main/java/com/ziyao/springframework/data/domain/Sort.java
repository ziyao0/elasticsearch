...
import com.ziyao.springframework.data.util.MethodInvocationRecorder;
import com.ziyao.springframework.data.util.MethodInvocationRecorder.Recorded;
 ...
 */
public class Sort implements Streamable<com.ziyao.springframework.data.domain.Sort.Order>, Serializable {
	...
	public static class TypedSort<T> extends Sort {
		...
		/*
		 * (non-Javadoc)
		 * @see com.ziyao.springframework.data.domain.Sort#iterator()
		 */
		@Override
		public Iterator<Order> iterator() {
		...
		/*
		 * (non-Javadoc)
		 * @see com.ziyao.springframework.data.domain.Sort#toString()
		 */
		@Override
		public String toString() {

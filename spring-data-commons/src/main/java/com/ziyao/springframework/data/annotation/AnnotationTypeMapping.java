...
import com.ziyao.springframework.data.annotation.AliasFor;
...
final class AnnotationTypeMapping {
    ...
    /**
     * Determine if the given annotation attribute in the {@codeplain #getRoot()
     ...
     * is declared via {@code com.ziyao.springframework.data.annotation.AliasFor @AliasFor}.
     ...
     * {@code #getAnnotation() meta-annotation}.
    ...
    /**
     * A collection of {@code MirrorSet} instances that provides details of all
     * defined mirrors.
     */
    class MirrorSets {

...
import com.ziyao.springframework.data.spel.ExpressionDependencies.ExpressionDependency;
...
import static com.ziyao.springframework.data.util.StreamUtils.*;
...
class EvaluationContextExtensionInformation {
	...
	public EvaluationContextExtensionInformation(Class<? extends EvaluationContextExtension> type) {
		...
		Class<?> rootObjectType = com.ziyao.springframework.data.util.ReflectionUtils.findRequiredMethod(type, "getRootObject")
				.getReturnType();

...
public final class ReflectionUtils {
	...
	public static class AnnotationFieldFilter implements DescribedFieldFilter {
		...
		/*
		 * (non-Javadoc)
		 * @see com.ziyao.springframework.data.util.ReflectionUtils.DescribedFieldFilter#getDescription()
		 */
	...
	public static Method findRequiredMethod(Class<?> type, String name, Class<?>... parameterTypes) {
		...
		while (searchType != null) {
			Method[] methods = (searchType.isInterface() ? searchType.getMethods()
					: com.ziyao.springframework.data.annotation.ReflectionUtils.getDeclaredMethods(searchType));

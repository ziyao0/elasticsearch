 ...
 * the {@link com.ziyao.springframework.data.mapping.PersistentProperty}'s name.
 *
 * @since 1.9
...
public class CamelCaseAbbreviatingFieldNamingStrategy extends CamelCaseSplittingFieldNamingStrategy {
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.mongodb.core.mapping.CamelCaseSplittingFieldNamingStrategy#preparePart(java.lang.String)
	 */
	@Override

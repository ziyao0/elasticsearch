...
/**
 * Provides a quick way to access the attribute methods of an {@code Annotation}
...
final class AttributeMethods {
     ...
     * causing any {@code TypeNotPresentException TypeNotPresentExceptions}.
     *
    ...
    boolean isValid(Annotation annotation) {
        ...
        for (int i = 0; i < size(); i++) {
            if (canThrowTypeNotPresentException(i)) {
                try {
                  com.ziyao.springframework.data.annotation.AnnotationUtils.invokeAnnotationMethod(get(i), annotation);
                } catch (Throwable ex) {
                    return false;
                }
            }
     ...
     * any {@code TypeNotPresentException TypeNotPresentExceptions}. In particular,

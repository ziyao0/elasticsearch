...
import com.ziyao.springframework.data.config.TypeFilterParser;
import com.ziyao.springframework.data.config.TypeFilterParser.Type;
import com.ziyao.springframework.data.repository.query.QueryLookupStrategy.Key;
import com.ziyao.springframework.data.util.ParsingUtils;
...
public class XmlRepositoryConfigurationSource extends RepositoryConfigurationSourceSupport {
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.repository.config.RepositoryConfigurationSource#getSource()
	 */
	@Nullable
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.repository.config.RepositoryConfigurationSource#getBasePackages()
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.repository.config.RepositoryConfigurationSource#getQueryLookupStrategyKey()
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.repository.config.RepositoryConfigurationSource#getNamedQueryLocation()
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.repository.config.RepositoryConfigurationSourceSupport#getExcludeFilters()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.repository.config.RepositoryConfigurationSourceSupport#getIncludeFilters()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.ziyao.springframework.data.repository.config.RepositoryConfigurationSource#getRepositoryImplementationPostfix()
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.repository.config.RepositoryConfigurationSource#getRepositoryFactoryBeanName()
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.repository.config.RepositoryConfigurationSource#getRepositoryBaseClassName()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.repository.config.RepositoryConfigurationSource#getRepositoryFactoryBeanClassName()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.repository.config.RepositoryConfigurationSourceSupport#isConsideringNestedRepositoriesEnabled()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.repository.config.RepositoryConfigurationSource#getAttribute(java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.repository.config.RepositoryConfigurationSource#getAttribute(java.lang.String, java.lang.Class)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.repository.config.RepositoryConfigurationSource#usesExplicitFilters()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.repository.config.RepositoryConfigurationSource#getBootstrapMode()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.repository.config.RepositoryConfigurationSource#getResourceDescription()
	 */
	@Override
	@NonNull

 ...
 * a {@link com.ziyao.springframework.data.mapping.IdentifierAccessor} to access the property value if requested.
 *
...
public class PersistentEntityInformation<T, ID> implements EntityInformation<T, ID> {
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.repository.core.support.AbstractEntityInformation#isNew(java.lang.Object)
	 */
	@Override

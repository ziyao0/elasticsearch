...
class EntityInstantiatorAdapter implements EntityInstantiator {
	...
	private final com.ziyao.springframework.data.mapping.model.EntityInstantiator delegate;

	EntityInstantiatorAdapter(com.ziyao.springframework.data.mapping.model.EntityInstantiator delegate) {

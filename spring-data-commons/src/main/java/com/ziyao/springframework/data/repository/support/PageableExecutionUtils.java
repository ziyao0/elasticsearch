 ...
 * @since 1.13
 * @deprecated since 2.4. Use {@link com.ziyao.springframework.data.support.PageableExecutionUtils} instead
 */
@Deprecated
public abstract class PageableExecutionUtils {
	...
	public static <T> Page<T> getPage(List<T> content, Pageable pageable, LongSupplier totalSupplier) {
		return com.ziyao.springframework.data.support.PageableExecutionUtils.getPage(content, pageable, totalSupplier);
	}
}

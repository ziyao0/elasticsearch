...
class TypeDiscoverer<S> implements TypeInformation<S> {
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.util.TypeInformation#getParameterTypes(java.lang.reflect.Constructor)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.util.TypeInformation#getProperty(java.lang.String)
	 */
	@Nullable
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.util.TypeInformation#getRawTypeInformation()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.util.TypeInformation#getActualType()
	 */
	@Nullable
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.util.TypeInformation#isMap()
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.util.TypeInformation#getMapValueType()
	 */
	@Nullable
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.util.TypeInformation#isCollectionLike()
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.util.TypeInformation#getComponentType()
	 */
	@Nullable
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.util.TypeInformation#getReturnType(java.lang.reflect.Method)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.util.TypeInformation#getMethodParameterTypes(java.lang.reflect.Method)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.util.TypeInformation#getSuperTypeInformation(java.lang.Class)
	 */
	@Nullable
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.util.TypeInformation#getTypeParameters()
	 */
	...
	/* (non-Javadoc)
	 * @see com.ziyao.springframework.data.util.TypeInformation#isAssignableFrom(com.ziyao.springframework.data.util.TypeInformation)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.util.TypeInformation#specialize(com.ziyao.springframework.data.util.ClassTypeInformation)
	 */
	@Override

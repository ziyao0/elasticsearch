...
import com.ziyao.springframework.data.annotation.AnnotatedElementUtils;
import com.ziyao.springframework.data.annotation.Immutable;
import com.ziyao.springframework.data.annotation.TypeAlias;
import com.ziyao.springframework.data.domain.Persistable;
import com.ziyao.springframework.data.mapping.*;
import com.ziyao.springframework.data.spel.EvaluationContextProvider;
import com.ziyao.springframework.data.spel.ExpressionDependencies;
import com.ziyao.springframework.data.support.IsNewStrategy;
import com.ziyao.springframework.data.support.PersistableIsNewStrategy;
import com.ziyao.springframework.data.util.Lazy;
...
public class BasicPersistentEntity<T, P extends PersistentProperty<P>> implements MutablePersistentEntity<T, P> {
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.mapping.PersistentEntity#getPersistenceConstructor()
	 */
	@Nullable
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.mapping.PersistentEntity#isConstructorArgument(com.ziyao.springframework.data.mapping.PersistentProperty)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.mapping.PersistentEntity#isIdProperty(com.ziyao.springframework.data.mapping.PersistentProperty)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.mapping.PersistentEntity#isVersionProperty(com.ziyao.springframework.data.mapping.PersistentProperty)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.mapping.PersistentEntity#getName()
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.mapping.PersistentEntity#getIdProperty()
	 */
	@Nullable
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.mapping.PersistentEntity#getVersionProperty()
	 */
	@Nullable
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.mapping.PersistentEntity#hasIdProperty()
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.mapping.PersistentEntity#hasVersionProperty()
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.mapping.model.MutablePersistentEntity#addPersistentProperty(P)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.mapping.model.MutablePersistentEntity#setEvaluationContextProvider(com.ziyao.springframework.data.spel.EvaluationContextProvider)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.mapping.model.MutablePersistentEntity#addAssociation(com.ziyao.springframework.data.mapping.model.Association)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.mapping.PersistentEntity#getPersistentProperty(java.lang.String)
	 */
	@Override
	@Nullable
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.mapping.PersistentEntity#getPersistentProperties(java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.mapping.PersistentEntity#getType()
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.mapping.PersistentEntity#getTypeAlias()
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.mapping.PersistentEntity#getTypeInformation()
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.mapping.PersistentEntity#doWithProperties(com.ziyao.springframework.data.mapping.PropertyHandler)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.mapping.PersistentEntity#doWithProperties(com.ziyao.springframework.data.mapping.PropertyHandler.Simple)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.mapping.PersistentEntity#doWithAssociations(com.ziyao.springframework.data.mapping.AssociationHandler)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.mapping.PersistentEntity#doWithAssociations(com.ziyao.springframework.data.mapping.SimpleAssociationHandler)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.mapping.PersistentEntity#findAnnotation(java.lang.Class)
	 */
	@Nullable
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.mapping.PersistentEntity#isAnnotationPresent(java.lang.Class)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.mapping.model.MutablePersistentEntity#verify()
	 */
	public void verify() {
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.mapping.model.MutablePersistentEntity#setPersistentPropertyAccessorFactory(com.ziyao.springframework.data.mapping.model.PersistentPropertyAccessorFactory)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.mapping.PersistentEntity#getPropertyAccessor(java.lang.Object)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.mapping.PersistentEntity#getPropertyPathAccessor(java.lang.Object)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.mapping.PersistentEntity#getIdentifierAccessor(java.lang.Object)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.mapping.PersistentEntity#isNew(java.lang.Object)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.mapping.PersistentEntity#isImmutable()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.mapping.PersistentEntity#requiresPropertyPopulation()
	 */
	@Override
	...
	private static class AbsentIdentifierAccessor extends TargetAwareIdentifierAccessor {
		...
		/*
		 * (non-Javadoc)
		 * @see com.ziyao.springframework.data.mapping.IdentifierAccessor#getIdentifier()
		 */
		@Override
		@Nullable

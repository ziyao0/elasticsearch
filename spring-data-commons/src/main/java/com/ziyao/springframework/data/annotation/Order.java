 ...
 *
 * <p>The {@code #value} is optional and represents an order value as defined in the
 * {@code Ordered} interface. Lower values have higher priority. The default value is
 ...
 *
 * <p>Since Spring 4.1, the standard {@code jakarta.annotation.Priority} annotation
 ...
 * has to be picked (see {@code com.ziyao.springframework.data.annotation.AnnotationAwareOrderComparator#getPriority}).
 *
 * <p>Alternatively, order values may also be determined on a per-instance basis
 * through the {@code Ordered} interface, allowing for configuration-determined
 * instance values instead of hard-coded values attached to a particular class.
 *
 * <p>Consult the javadoc for {@code org.springframework.core.OrderComparator
...
public @interface Order {
    ...
    /**
     * The order value.
     * <p>Default is {@code Ordered#LOWEST_PRECEDENCE}.
     *

 ...
 * {@code #annotation} attribute of {@code @AliasFor} is set to a different
 * annotation than the one that declares it, the {@code #attribute} is
 ...
 * enforced, annotations must be <em>loaded</em> via {@code MergedAnnotations}.
 *
 ...
 * {@code @AliasFor}, and either {@code #attribute} or {@code #value} must
 ...
 * <li>{@code #annotation} should not be declared.</li>
 * </ol>
 * </li>
 ...
 * must be annotated with {@code @AliasFor}, and {@code #attribute} must
 * reference the attribute in the meta-annotation.</li>
 * <li>Aliased attributes must declare the same return type.</li>
 * <li>{@code #annotation} must reference the meta-annotation.</li>
 ...
 * annotated with {@code @AliasFor}, and {@code #attribute} must reference
 ...
 * <li>Aliased attributes must declare a default value.</li>
 * <li>Aliased attributes must declare the same default value.</li>
 * <li>{@code #annotation} must reference an appropriate meta-annotation.</li>
 * <li>The referenced meta-annotation must be <em>meta-present</em> on the
 * annotation class that declares {@code @AliasFor}.</li>
 * </ol>
 * </li>
...
public @interface AliasFor {
     ...
     * <p>Intended to be used instead of {@code #attribute} when {@code #annotation}
    ...
    /**
     * The type of annotation in which the aliased {@code #attribute} is declared.
     * <p>Defaults to {@code Annotation}, implying that the aliased attribute is

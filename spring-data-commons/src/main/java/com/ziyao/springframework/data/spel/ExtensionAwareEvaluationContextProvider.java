 ...
 */
package com.ziyao.springframework.data.spel;

import org.springframework.beans.factory.BeanFactory;
import org.springframework.beans.factory.ListableBeanFactory;
import org.springframework.context.expression.BeanFactoryResolver;
import com.ziyao.springframework.data.annotation.AnnotationAwareOrderComparator;
import org.springframework.core.convert.TypeDescriptor;
import com.ziyao.springframework.data.spel.EvaluationContextExtensionInformation.ExtensionTypeInformation;
import com.ziyao.springframework.data.spel.EvaluationContextExtensionInformation.RootObjectInformation;
import com.ziyao.springframework.data.spel.spi.EvaluationContextExtension;
import com.ziyao.springframework.data.spel.spi.ExtensionIdAware;
import com.ziyao.springframework.data.spel.spi.Function;
import com.ziyao.springframework.data.util.Lazy;
import com.ziyao.springframework.data.util.Optionals;
import com.ziyao.springframework.data.util.Predicates;
...
public class ExtensionAwareEvaluationContextProvider implements EvaluationContextProvider {
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.spel.EvaluationContextProvider#getEvaluationContext(Object)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.spel.EvaluationContextProvider#getEvaluationContext(Object, ExpressionDependencies)
	 */
	@Override
	...
	class ExtensionAwarePropertyAccessor implements PropertyAccessor, MethodResolver {
		...
		/*
		 * (non-Javadoc)
		 * @see com.ziyao.springframework.data.repository.query.ExtensionAwareEvaluationContextProvider.ReadOnlyPropertyAccessor#canRead(org.springframework.expression.EvaluationContext, java.lang.Object, java.lang.String)
		 */
		@Override

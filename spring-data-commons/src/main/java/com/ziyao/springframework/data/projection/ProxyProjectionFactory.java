 ...
 */
package com.ziyao.springframework.data.projection;
...
import com.ziyao.springframework.data.util.NullableWrapperConverters;
...
class ProxyProjectionFactory implements ProjectionFactory, BeanClassLoaderAware {
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.rest.core.projection.ProjectionFactory#createProjection(java.lang.Object, java.lang.Class)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.projection.ProjectionFactory#createProjection(java.lang.Class)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.ziyao.springframework.data.projection.ProjectionFactory#getProjectionInformation(java.lang.Class)
	 */
	@Override
	...
	private static enum MapAccessingMethodInterceptorFactory implements MethodInterceptorFactory {
		...
		/*
		 * (non-Javadoc)
		 * @see com.ziyao.springframework.data.projection.MethodInterceptorFactory#createMethodInterceptor(java.lang.Object, java.lang.Class)
		 */
		@Override
		@SuppressWarnings("unchecked")
		...
		/*
		 * (non-Javadoc)
		 * @see com.ziyao.springframework.data.projection.MethodInterceptorFactory#supports(java.lang.Object, java.lang.Class)
		 */
		@Override

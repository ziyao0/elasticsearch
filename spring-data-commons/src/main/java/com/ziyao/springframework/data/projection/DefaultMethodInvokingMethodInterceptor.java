...
public class DefaultMethodInvokingMethodInterceptor implements MethodInterceptor {
	...
	enum MethodHandleLookup {
		...
		ENCAPSULATED {
			...
			/*
			 * (non-Javadoc)
			 * @see com.ziyao.springframework.data.projection.DefaultMethodInvokingMethodInterceptor.MethodHandleLookup#lookup(java.lang.reflect.Method)
			 */
			@Override
			...
			/*
			 * (non-Javadoc)
			 * @see com.ziyao.springframework.data.projection.DefaultMethodInvokingMethodInterceptor.MethodHandleLookup#isAvailable()
			 */
			@Override
			boolean isAvailable() {
